  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function BindDdl4EditRegionInDiv() {
        ...
        arrViewRegion.value = await ViewRegion_GetArrViewRegionByPrjId(strPrjId); //编辑区域
        regionId.value = '0';
      }
      ...
      async function GetEditDataViewRegionRelaObj() {
        ...
        pobjViewRegionRelaEN.SetRegionId(Is0EqEmpty(regionId.value)); // 区域Id
      ...
      async function ShowDataFromViewRegionRelaObj(pobjViewRegionRelaEN: clsViewRegionRelaEN) {
        regionId.value = IsNullOrEmptyEq0(pobjViewRegionRelaEN.regionId); // 区域Id
              ...
              if (['02', '03', '06'].indexOf(clsViewRegionRelaEN.PrimaryTypeId) > -1) {
                ...
                if (returnKeyId != 0) {
                  ...
                  if (objPage_Edit.value.iShowList != null)
                    objPage_Edit.value.iShowList.BindGvCache(clsViewRegionRelaEN._CurrTabName, '');
                }
              } else {
      ...
      const showDialog = async (pobjPage_Edit: ViewRegionRela_EditEx) => {
