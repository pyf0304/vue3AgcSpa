      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.labelCaption"></td>

            <td v-html="item.defaultValue"></td>

            <td v-html="item.orderNum"></td>

            <td v-html="item.cssClass"></td>

            <td v-html="item.fldIdCond2"></td>

            <td v-html="item.fldIdCond1"></td>

            <td v-html="item.varIdCond2"></td>

            <td v-html="item.varIdCond1"></td>

            <td v-html="item.varTypeIdCond2"></td>

            <td v-html="item.varTypeIdCond1"></td>

            <td v-html="item.tabFeatureId4Ddl"></td>

            <td v-html="item.dsCondStr"></td>

            <td v-html="item.dsSqlStr"></td>

            <td v-html="item.itemsString"></td>
