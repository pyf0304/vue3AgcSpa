      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('constId')">
              常量Id
              <span>
                <i
                  :class="
                    sortColumnKey === 'constId'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('constName|Ex')">
              常量名
              <span>
                <i
                  :class="
                    sortColumnKey === 'constName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('dataTypeName|Ex')">
              数据类型名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'dataTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('csType|Ex')">
              CS类型
              <span>
                <i
                  :class="
                    sortColumnKey === 'csType|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('typeScriptType|Ex')">
              TypeScript类型
              <span>
                <i
                  :class="
                    sortColumnKey === 'typeScriptType|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('prjId|Ex')">
              工程Id
              <span>
                <i
                  :class="
                    sortColumnKey === 'prjId|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('prjName|Ex')">
              工程名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'prjName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('updUser')">
              修改者
              <span>
                <i
                  :class="
                    sortColumnKey === 'updUser'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.constId"></td>

            <td v-html="item.constName"></td>

            <td v-html="item.dataTypeName"></td>

            <td v-html="item.csType"></td>

            <td v-html="item.typeScriptType"></td>

            <td v-html="item.prjId"></td>

            <td v-html="item.prjName"></td>
