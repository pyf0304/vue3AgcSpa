  ...
  <div id="divLayout" ref="refDivLayout" class="div_layout">
    ...
    <div id="divFunction" ref="refDivFunction" class="table table-bordered table-hover">
      <ul class="nav">
        ...
        <li class="nav-item ml-3">
          <button
            id="btnSetFldIdForCurrPrjId"
            name="btnSetFldIdForCurrPrjId"
            class="btn btn-outline-info btn-sm text-nowrap"
            @click="btnSetFldIdForCurrPrjId_Click"
            >设置本项目的字段</button
          >
        </li>
      </ul>
    ...
    <div id="divList" ref="refDivList" class="div_List">
      <GCVariable_ListCom
        ref="refGCVariable_List"
        :items="dataListGCVariable"
...
<script lang="ts">
  ...
  import GCVariable_ListCom from '@/views/GeneCode/GCVariable_List.vue';
  ...
  export default defineComponent({
    ...
    methods: {
      ...
      async EditTabRelaInfo(data: any) {
        ...
        router.push({ name: 'editGCVariable', params: { courseId: data.courseId } });
      },
      ...
      async SortColumn(data: any) {
        console.log('data:', data);
        const objPage = new GCVariableCRUDEx();
