      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('constName')">
              常量名
              <span>
                <i
                  :class="
                    sortColumnKey === 'constName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('constExpression')">
              常量表达式
              <span>
                <i
                  :class="
                    sortColumnKey === 'constExpression'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('filePath')">
              文件路径
              <span>
                <i
                  :class="
                    sortColumnKey === 'filePath'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('initValue')">
              初始值
              <span>
                <i
                  :class="
                    sortColumnKey === 'initValue'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('clsName')">
              类名
              <span>
                <i
                  :class="
                    sortColumnKey === 'clsName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.constExpression"></td>
