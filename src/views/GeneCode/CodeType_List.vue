      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.frontOrBack"></td>

            <td v-html="item.sqlDsTypeName"></td>

            <td v-html="item.classNameFormat"></td>

            <td v-html="item.fileNameFormat"></td>

            <td v-html="item.classNamePattern"></td>

            <td v-html="item.isDefaultOverride"></td>

            <td v-html="item.prefix"></td>

            <td v-html="item.isExtend"></td>

            <td v-html="item.isDirByTabName"></td>

            <td v-html="item.inUse"></td>

            <td v-html="item.isAutoParseFile"></td>
