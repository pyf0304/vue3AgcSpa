      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.progLangTypeId2"></td>

            <td v-html="item.progLangTypeId3"></td>

            <td v-html="item.progLangTypeId4"></td>

            <td v-html="item.progLangTypeId5"></td>

            <td v-html="item.isVisible"></td>

            <td v-html="item.visitedNum"></td>
