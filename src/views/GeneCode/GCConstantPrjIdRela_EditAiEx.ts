 ...
 * 表名:GCConstantPrjIdRela(0005)
 * 版本:2026.05.29(服务器:PYF-AI)
 * 日期:2026/05/29 23:55:50
 * 生成者:
 * 工程名称:AGC(0005)
 ...
 *
 * 扩展说明:
 * 1、继承自 GCConstantPrjIdRela_EditAi 基类
 * 2、可在此类中添加自定义业务逻辑
 * 3、不会被代码生成器覆盖
 */
export default class GCConstantPrjIdRela_EditAiEx extends GCConstantPrjIdRela_EditAi {
  /**
   * 构造函数
   * (AutoGCLib.Vue_ViewScript_EditCSAiEx_TS4TypeScript:Gen_Constructor)
   */
  constructor(objShowList: any) {
    super('GCConstantPrjIdRela_EditAiEx', objShowList);
  }
   ...
   */
  public btnEdit_Click(strCommandName: string, key: GCConstantPrjIdRelaKey | null): void {
