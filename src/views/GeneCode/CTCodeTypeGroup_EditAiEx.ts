/**
 * 类名:CTCodeTypeGroup_EditEx(界面:CTCodeTypeGroupCRUD,00050349)
 * 表名:CTCodeTypeGroup(0005)
 * 版本:2026.06.06(服务器:PYF-AI)
 * 日期:2026/06/06 12:01:51
 * 生成者:
 * 工程名称:AGC(0005)
...
/**
 * CTCodeTypeGroup_EditEx 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScript_EditCSAiEx_TS4TypeScript:GeneCode)
 *
 * 扩展说明:
 * 1、继承自 CTCodeTypeGroup_EditAi 基类
 * 2、可在此类中添加自定义业务逻辑
 * 3、不会被代码生成器覆盖
 */
export default class CTCodeTypeGroup_EditAiEx extends CTCodeTypeGroup_EditAi {
  /**
   * 构造函数
   * (AutoGCLib.Vue_ViewScript_EditCSAiEx_TS4TypeScript:Gen_Constructor)
   */
  constructor(objShowList: any) {
    super('CTCodeTypeGroup_EditAiEx', objShowList);
  }
   ...
   */
  public btnEdit_Click(strCommandName: string, key: CTCodeTypeGroupKey | null): void {
