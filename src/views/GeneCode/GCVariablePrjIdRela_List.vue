      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('varTypeName|Ex')">
              变量类型名
              <span>
                <i
                  :class="
                    sortColumnKey === 'varTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('fldName|Ex')">
              字段名
              <span>
                <i
                  :class="
                    sortColumnKey === 'fldName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
