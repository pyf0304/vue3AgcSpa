...
import { divVarSet, refApplicationType_Edit } from '@/views/GeneCode/ApplicationTypeVueShare';
...
export default class ApplicationTypeCRUDEx extends ApplicationTypeCRUD implements IShowList {
  ...
  //public static mstrSortApplicationTypeBy = "ApplicationTypeId";
  /**
   * 每页记录数，在扩展类可以修改
   **/
  ...
  public static btn_Click(strCommandName: string, strKeyId: string) {
    ...
    if (ApplicationTypeCRUD.objPageCRUD == null) {
      ...
      objPage = <ApplicationTypeCRUDEx>ApplicationTypeCRUD.objPageCRUD;
    } else {
      objPage = <ApplicationTypeCRUDEx>ApplicationTypeCRUD.objPageCRUD;
    }
    const objPageEdit = new ApplicationType_EditEx('ApplicationType_EditEx', objPage);
    ...
    switch (strCommandName) {
      ...
      case 'ReOrder': //重序记录
        ...
        break;
      default:
        AccessBtnClickDefault(strCommandName, 'ApplicationTypeCRUDEx.btn_Click');
