      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('applicationTypeName|Ex')">
              应用程序类型名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'applicationTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('dependsOn|Ex')">
              依赖于
              <span>
                <i
                  :class="
                    sortColumnKey === 'dependsOn|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('groupName|Ex')">
              组名
              <span>
                <i
                  :class="
                    sortColumnKey === 'groupName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.mId"></td>

            <td v-html="item.applicationTypeName"></td>

            <td v-html="item.codeTypeSimName"></td>

            <td v-html="item.codeTypeId"></td>
            ...
            <td v-html="item.applicationTypeId"></td>

            <td v-html="item.viewTypeCode"></td>

            <td v-html="item.tabMainTypeId"></td>

            <td v-html="item.isVisible"></td>

            <td v-html="item.isInGroupGeneCode"></td>
