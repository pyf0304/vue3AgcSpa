  ...
  <a-modal v-model:visible="dialogVisible" :width="dialogWidth" :title="strTitle">
    ...
    <template #footer>
      ...
      <a-button
        ...
        type="primary"
        @click="btnGCConstantPrjIdRela_Edit_Click('Submit', null)"
...
<script lang="ts">
  ...
  import GCConstantPrjIdRela_EditAiEx from '@/views/GeneCode/GCConstantPrjIdRela_EditAiEx';
  import {
  ...
  import { GCConstantPrjIdRela_EditAi } from '@/viewsBase/GeneCode/GCConstantPrjIdRela_EditAi';
  import { enumPageDispMode } from '@/ts/PubFun/enumPageDispMode';
  export default defineComponent({
    name: 'GCConstantPrjIdRelaEditAi',
    ...
    setup() {
      ...
      const keyId = ref('');
      const objPage_Edit = ref<GCConstantPrjIdRela_EditAiEx>();
       ...
       **/
      const showDialog = async (pobjPage_Edit: GCConstantPrjIdRela_EditAiEx) => {
    ...
    methods: {
       ...
       **/
      btnGCConstantPrjIdRela_Edit_Click(
        strCommandName: string,
        key: GCConstantPrjIdRelaKey | null,
      ) {
        const objPageEdit = this.objPage_Edit as GCConstantPrjIdRela_EditAiEx | undefined;
        if (objPageEdit == null) {
          const strMsg = '编辑页面初始化不成功,请联系管理员!(in btnGCConstantPrjIdRela_Edit_Click)';
          console.error(strMsg);
          alert(strMsg);
          return;
        }
        if (key == null || IsNullOrEmpty(key.prjId) == true || IsNullOrEmpty(key.constId) == true) {
