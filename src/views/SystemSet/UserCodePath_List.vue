      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('progLangTypeSimName|Ex')">
              语言
              <span>
                <i
                  :class="
                    sortColumnKey === 'progLangTypeSimName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('cmPrjName|Ex')">
              CM工程名
              <span>
                <i
                  :class="
                    sortColumnKey === 'cmPrjName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('codeTypeSimName|Ex')">
              代码类型
              <span>
                <i
                  :class="
                    sortColumnKey === 'codeTypeSimName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('isGeneCode')">
              生成?
              <span>
                <i
                  :class="
                    sortColumnKey === 'isGeneCode'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('isExistCodePath')">
              存在?
              <span>
                <i
                  :class="
                    sortColumnKey === 'isExistCodePath'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('projectFileName')">
              工程文件名
              <span>
                <i
                  :class="
                    sortColumnKey === 'projectFileName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('gcPathName|Ex')">
              GC路径名
              <span>
                <i
                  :class="
                    sortColumnKey === 'gcPathName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.progLangTypeSimName"></td>

            <td v-html="item.applicationTypeSimName"></td>

            <td v-html="item.cmPrjName"></td>

            <td v-html="item.tabMainTypeName"></td>

            <td v-html="item.codeTypeSimName"></td>

            <td v-html="item.isGeneCode"></td>

            <td v-html="item.isExistCodePath"></td>

            <td v-html="item.codePath"></td>

            <td v-html="item.projectPath"></td>

            <td v-html="item.projectFileName"></td>

            <td v-html="item.gcPathName"></td>

            <td v-html="item.suffixPath"></td>

            <td v-html="item.isTemplate"></td>

            <td v-html="item.codePathBackup"></td>
