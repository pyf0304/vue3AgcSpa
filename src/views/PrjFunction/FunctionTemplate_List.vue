      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('functionTemplateId')">
              函数模板Id
              <span>
                <i
                  :class="
                    sortColumnKey === 'functionTemplateId'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('functionTemplateName')">
              函数模板名
              <span>
                <i
                  :class="
                    sortColumnKey === 'functionTemplateName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('functionTemplateENName')">
              函数模板英文名
              <span>
                <i
                  :class="
                    sortColumnKey === 'functionTemplateENName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            <td>
              <input
                :id="'chk' + item.functionTemplateId"
            ...
            <td v-html="item.functionTemplateId"></td>

            <td v-html="item.functionTemplateName"></td>

            <td v-html="item.functionTemplateENName"></td>
    ...
    setup(props, { emit }) {
      ...
      const btnClickInRow = (item: any) => {
        emit('on-edit-tab-relainfo', {
          functionTemplateId: item.functionTemplateId,
          content: '这是当前表的关键字',
        });
      };
