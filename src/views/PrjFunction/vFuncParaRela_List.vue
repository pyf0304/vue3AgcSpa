      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.functionSignature"></td>
            ...
            <td v-html="item.javaType"></td>

            <td v-html="item.javaObjType"></td>

            <td v-html="item.swiftType"></td>

            <td v-html="item.isNeedQuote"></td>
