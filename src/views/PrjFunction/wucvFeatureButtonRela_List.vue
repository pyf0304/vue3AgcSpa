      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('applicationTypeENName|Ex')">
              应用类型英文名
              <span>
                <i
                  :class="
                    sortColumnKey === 'applicationTypeENName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('featureTypeName|Ex')">
              功能类型名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'featureTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('buttonName|Ex')">
              按钮名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'buttonName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('orderNum|Ex')">
              序号
              <span>
                <i
                  :class="
                    sortColumnKey === 'orderNum|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('text|Ex')">
              文本
              <span>
                <i
                  :class="
                    sortColumnKey === 'text|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.applicationTypeENName"></td>

            <td v-html="item.featureName"></td>

            <td v-html="item.featureTypeName"></td>

            <td v-html="item.buttonName"></td>
            ...
            <td v-html="item.eventFuncName"></td>
...
<script lang="ts">
  ...
  export default defineComponent({
    name: 'WucvFeatureButtonRelaList',
    components: {
      // 组件注册
    },
