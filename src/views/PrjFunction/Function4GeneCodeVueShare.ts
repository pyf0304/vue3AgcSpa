...
const refFunction4GeneCode_DetailAi = ref();
...
export function Function4GeneCode_DeleteKeyIdCache(key: Function4GeneCodeKey): void {
  if (IsNullOrEmpty(key.funcId4GC) == false) {
    // 使用 delete 删除特定的键
    const cacheKey = `${key.funcId4GC}`;
