 ...
 * 版本:2026.04.29(服务器:PYF-AI)
 * 日期:2026/04/29 16:05:19
 * 生成者:
 * 工程名称:AGC(0005)
 ...
 * 3、不会被代码生成器覆盖
 */
export default class FunctionTemplate_EditEx extends FunctionTemplate_EditAi {
  /**
   * 构造函数
   * (AutoGCLib.Vue_ViewScript_EditCSExAi_TS4TypeScript:Gen_Constructor)
   */
  constructor(objShowList: any) {
    super('FunctionTemplate_EditEx', objShowList);
  }
