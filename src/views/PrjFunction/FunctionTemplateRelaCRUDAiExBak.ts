  ...
  implements IShowList
{
   ...
   * 更新记录操作
   */
  public async onUpdate(strCommandName: string, key: FunctionTemplateRelaKey) {
    const objPageEdit = new FunctionTemplateRela_EditEx(this);
    console.log(objPageEdit);
    ...
    objPageEdit.btnEdit_Click(strCommandName, { mId: Number(currentKeyId) || Number(key.mId) });
  }
  ...
  public async executeCommand(
    ...
    switch (commandId) {
      ...
      case 'create':
        ...
        return;
      case 'update':
        await this.onUpdate('Update', { mId: 0 });
        return;
      case 'delete':
        await this.onDelete();
        return;
