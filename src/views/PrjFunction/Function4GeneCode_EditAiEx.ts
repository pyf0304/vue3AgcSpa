 ...
 * 表名:Function4GeneCode(0005)
 * 版本:2026.05.27(服务器:PYF-AI)
 * 日期:2026/05/27 14:16:45
 * 生成者:
 * 工程名称:AGC(0005)
 ...
 *
 * 扩展说明:
 * 1、继承自 Function4GeneCode_EditAi 基类
 * 2、可在此类中添加自定义业务逻辑
 * 3、不会被代码生成器覆盖
 */
export default class Function4GeneCode_EditAiEx extends Function4GeneCode_EditAi {
  /**
   * 构造函数
   * (AutoGCLib.Vue_ViewScript_EditCSAiEx_TS4TypeScript:Gen_Constructor)
   */
  constructor(objShowList: any) {
    super('Function4GeneCode_EditAiEx', objShowList);
  }
   ...
   */
  public btnEdit_Click(strCommandName: string, key: Function4GeneCodeKey) {
