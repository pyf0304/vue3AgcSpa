      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('funcId4GC')">
              函数ID
              <span>
                <i
                  :class="
                    sortColumnKey === 'funcId4GC'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('funcName')">
              函数名
              <span>
                <i
                  :class="
                    sortColumnKey === 'funcName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('featureName|Ex')">
              功能
              <span>
                <i
                  :class="
                    sortColumnKey === 'featureName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('funcName4Code|Ex')">
              函数名4Code
              <span>
                <i
                  :class="
                    sortColumnKey === 'funcName4Code|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('funcGCTypeName|Ex')">
              生成对象类型
              <span>
                <i
                  :class="
                    sortColumnKey === 'funcGCTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('progLangTypeName|Ex')">
              语言
              <span>
                <i
                  :class="
                    sortColumnKey === 'progLangTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('codeTypeName|Ex')">
              代码类型
              <span>
                <i
                  :class="
                    sortColumnKey === 'codeTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('usedTimes')">
              使用次数
              <span>
                <i
                  :class="
                    sortColumnKey === 'usedTimes'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('inUse|Ex')">
              在用?
              <span>
                <i
                  :class="
                    sortColumnKey === 'inUse|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.funcId4GC"></td>

            <td v-html="item.funcName"></td>

            <td v-html="item.featureName"></td>

            <td v-html="item.funcName4Code"></td>

            <td v-html="item.funcGCTypeName"></td>

            <td v-html="item.progLangTypeName"></td>

            <td v-html="item.codeTypeName"></td>

            <td v-html="item.sqlDsTypeName"></td>

            <td v-html="item.funcTypeName"></td>

            <td v-html="item.usedTimes"></td>
