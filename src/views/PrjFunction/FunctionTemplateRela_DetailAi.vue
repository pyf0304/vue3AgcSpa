...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
       ...
       * (AutoGCLib.Vue_ViewScript_Detail4Html:Gen_Detail_setup_ShowDataFromObj)
      ...
      /**
       * 显示对话框
       * (AutoGCLib.Vue_ViewScript_Detail4Html:Gen_Detail_Setup_ShowDialog)
       **/
      const showDialog = () => {
      ...
      /**
       * 隐藏对话框
       * (AutoGCLib.Vue_ViewScript_Detail4Html:Gen_Detail_Setup_HideDialog)
       **/
      const hideDialog = () => {
    ...
    methods: {
       ...
       *(AutoGCLib.Vue_ViewScript_Detail4Html:Gen_Vue_JS_btnDetail_Click)
       **/
