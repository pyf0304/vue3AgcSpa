      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('viewNum|Ex')">
              界面数
              <span>
                <i
                  :class="
                    sortColumnKey === 'viewNum|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.funcModuleAgcId"></td>

            <td v-html="item.funcModuleName"></td>

            <td v-html="item.funcModuleEnName"></td>

            <td v-html="item.funcModuleNameSim"></td>

            <td v-html="item.useStateName"></td>

            <td v-html="item.viewNum"></td>
