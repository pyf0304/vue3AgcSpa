      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.prjDomain"></td>

            <td v-html="item.tableSpace"></td>

            <td v-html="item.getWebApiFunc"></td>

            <td v-html="item.isRelaDataBase"></td>

            <td v-html="item.javaPackageName"></td>

            <td v-html="item.isSupportMvc"></td>

            <td v-html="item.isoPrjName"></td>
