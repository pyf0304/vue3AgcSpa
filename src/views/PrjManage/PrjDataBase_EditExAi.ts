 ...
 * PrjDataBaseId:0005
 * 模块中文名:PrjManage
 * 框架-层名:Vue_编辑区后台Ex_TS(TS)(Vue_ViewScript_EditCSEx_TS,0270)
 * 编程语言:TypeScript
 **/
//import $ from "jquery";
...
export default class PrjDataBase_EditEx extends PrjDataBase_EditAi {
  /**
   * 构造函数
   * (AutoGCLib.Vue_ViewScript_EditCSEx_TS4TypeScript:Gen_Constructor)
   */
  constructor(objShowList: any) {
    super('PrjDataBase_EditEx', objShowList);
  }
