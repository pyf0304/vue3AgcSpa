    ...
    <template v-else>
      <table>
        <tr class="text-primary">
          ...
          <th @click="sortColumn('dataNodeTypeName|Ex')">
            结点类型
            <span>
              <i
                :class="
                  sortColumnKey === 'dataNodeTypeName|Ex'
                    ? sortDirection === 'Asc'
                      ? 'arrow-up'
                      : 'arrow-down'
                    : 'arrow-neutral'
        ...
        <tr v-for="(item, index) in items" :key="index" class="text-secondary">
          ...
          <td v-html="item.dataNodeId"></td>

          <td v-html="item.dataNodeName"></td>

          <td v-html="item.fldName"></td>

          <td v-html="item.dataNodeTypeName"></td>
