...
<script lang="ts">
  ...
  import { refDivEdit, PrjId_Session, CmPrjId_Local } from '@/views/AIModule/DataNodeVueShare';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function ShowDataFromDataNodeObj(pobjDataNodeEN: clsDataNodeEN) {
        ...
        arrvFieldTab_Sim.value = await vFieldTab_SimEx_GetArrvFieldTab_SimByTabIdCache(tabId.value); //编辑区域
        // fldId.value = '0';
    ...
    methods: {
      ...
      btnClick(strCommandName: string, strKeyId: string) {
        ...
        //}
        //DataNode_EditEx.btnClick(strCommandName, strKeyId);
      },
...
*/
      async ddlFldId_SelectedIndexChanged(e: Event) {
        ...
        const strNodeName = Format('{0}_{1}', objPrjTab.tabName, objFieldTab.fldName);
        this.dataNodeName = strNodeName;
      },
    },
  });
</script>
