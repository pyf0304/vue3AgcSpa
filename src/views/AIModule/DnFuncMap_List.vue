    ...
    <template v-else>
      <table>
        <tr class="text-primary">
          ...
          <th @click="sortColumn('inDataNodeName|Ex')">
            In结点
            <span>
              <i
                :class="
                  sortColumnKey === 'inDataNodeName|Ex'
                    ? sortDirection === 'Asc'
                      ? 'arrow-up'
                      : 'arrow-down'
                    : 'arrow-neutral'
          ...
          <th @click="sortColumn('outDataNodeName|Ex')">
            Out结点
            <span>
              <i
                :class="
                  sortColumnKey === 'outDataNodeName|Ex'
                    ? sortDirection === 'Asc'
                      ? 'arrow-up'
                      : 'arrow-down'
                    : 'arrow-neutral'
          ...
          <th @click="sortColumn('associationMappingName|Ex')">
            关系映射
            <span>
              <i
                :class="
                  sortColumnKey === 'associationMappingName|Ex'
                    ? sortDirection === 'Asc'
                      ? 'arrow-up'
                      : 'arrow-down'
                    : 'arrow-neutral'
          ...
          <th @click="sortColumn('funcMapModeName|Ex')">
            映射模式
            <span>
              <i
                :class="
                  sortColumnKey === 'funcMapModeName|Ex'
                    ? sortDirection === 'Asc'
                      ? 'arrow-up'
                      : 'arrow-down'
                    : 'arrow-neutral'
          ...
          <th @click="sortColumn('dnFunctionName|Ex')">
            DN函数
            <span>
              <i
                :class="
                  sortColumnKey === 'dnFunctionName|Ex'
                    ? sortDirection === 'Asc'
                      ? 'arrow-up'
                      : 'arrow-down'
                    : 'arrow-neutral'
        ...
        <tr v-for="(item, index) in items" :key="index" class="text-secondary">
          ...
          <td v-html="item.dnFuncMapId"></td>

          <td v-html="item.inDataNodeName"></td>

          <td v-html="item.outDataNodeName"></td>

          <td v-html="item.associationMappingName"></td>

          <td v-html="item.funcMapModeName"></td>

          <td v-html="item.dnFunctionName"></td>
