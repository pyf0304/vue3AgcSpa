      ...
      <table>
        <tr class="text-primary">
          ...
          <th @click="sortColumn('userName')">
            用户名
            <span v-if="sortColumnKey === 'userName'">
              <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
            </span>
          </th>
          ...
          <th @click="sortColumn('roleName')">
            角色名称
            <span v-if="sortColumnKey === 'roleName'">
              <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
            </span>
          </th>
          ...
          <th @click="sortColumn('departmentTypeName')">
            部门类型名
            <span v-if="sortColumnKey === 'departmentTypeName'">
              <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
            </span>
          </th>
