/**
 * 类名:QxUsersV2_EditEx(界面:QxUsersV2CRUD)
 * 表名:QxUsersV2(00140110)
 * 版本:2023.06.21.1(服务器:WIN-SRV103-116)
 * 日期:2023/06/22 08:45:53
 * 生成者:
 工程名称:统一平台(0014)
...
/* QxUsersV2_EditEx 的摘要说明。其中Q代表查询,U代表修改
  (AutoGCLib.Vue_ViewScript_EditCSEx_TS4TypeScript:GeneCode)
*/
export default class QxUsersV2_EditEx extends QxUsersV2_Edit {
  /**
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    const objPage = QxUsersV2_Edit.objPageEdit; //.GetPageEditObj('');
    if (objPage == null) {
