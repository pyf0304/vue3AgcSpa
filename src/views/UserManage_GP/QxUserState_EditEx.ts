/**
 * 类名:QxUserState_EditEx(界面:QxUserStateCRUD)
 * 表名:QxUserState(00140016)
 * 版本:2023.06.21.1(服务器:WIN-SRV103-116)
 * 日期:2023/06/22 08:45:51
 * 生成者:
 工程名称:统一平台(0014)
...
import { QxUserState_Edit } from '@/viewsBase/UserManage_GP/QxUserState_Edit';
/* QxUserState_EditEx 的摘要说明。其中Q代表查询,U代表修改
  (AutoGCLib.Vue_ViewScript_EditCSEx_TS4TypeScript:GeneCode)
*/
export default class QxUserState_EditEx extends QxUserState_Edit {
  /**
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    const objPage = QxUserState_Edit.objPageEdit; //.GetPageEditObj('');
    if (objPage == null) {
