/**
 * 类名:QxUserIdentity_EditEx(界面:QxUserIdentityCRUD)
...
import { QxUserIdentity_Edit } from '@/viewsBase/UserManage_GP/QxUserIdentity_Edit';
/* QxUserIdentity_EditEx 的摘要说明。其中Q代表查询,U代表修改
  (AutoGCLib.Vue_ViewScript_EditCSEx_TS4TypeScript:GeneCode)
*/
export default class QxUserIdentity_EditEx extends QxUserIdentity_Edit {
  /**
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    const objPage = QxUserIdentity_Edit.objPageEdit; //.GetPageEditObj('');
    if (objPage == null) {
