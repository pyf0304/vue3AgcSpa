...
<script lang="ts">
  ...
  export default {
    ...
    setup() {
      ...
      const links = ref([
        { source: 1, target: 2, description: '关系1' },
        { source: 2, target: 3, description: '关系2' },
        { source: 3, target: 1, description: '关系3' },
        { source: 4, target: 1, description: '关系4' },
        { source: 4, target: 5, description: '关系5' },
      ]);
      ...
      const drawGraph = () => {
        ...
        const link = svg
          ...
          .on('click', function (event: any, d: any) {
            selectedLink.value = selectedLink.value === d ? null : d;
            d3.selectAll('line').attr('stroke', (d: any) =>
              selectedLink.value === d ? 'blue' : 'red',
            );
          })
          .each(function (d: any) {
