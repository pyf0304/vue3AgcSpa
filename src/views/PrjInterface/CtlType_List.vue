      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.ctlTypeENName"></td>

            <td v-html="item.ctlCnName"></td>

            <td v-html="item.ctlTypeAbbr"></td>

            <td v-html="item.htmlCtrlTypeName"></td>

            <td v-html="item.isForApple"></td>
