      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('viewCnName')">
              视图中文名
              <span>
                <i
                  :class="
                    sortColumnKey === 'viewCnName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.inOutTypeId"></td>

            <td v-html="item.viewTabTypeId"></td>

            <td v-html="item.tabId"></td>

            <td v-html="item.tabFunction"></td>
