    ...
    <template v-else>
      <table>
        <tr class="text-primary">
          ...
          <th @click="sortColumn('cmPrjName')">
            CM工程
            <span v-if="sortColumnKey === 'cmPrjName'">
              <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
            </span>
          </th>

          <th @click="sortColumn('applicationTypeName')">
            应用类型
            <span v-if="sortColumnKey === 'applicationTypeName'">
              <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
            </span>
          </th>
        ...
        <tr v-for="(item, index) in items" :key="index" class="text-secondary">
          <td>
            <input
              :id="'chk' + item.cMProjectAppRelaId"
          ...
          <td v-html="item.cMProjectAppRelaId"></td>
