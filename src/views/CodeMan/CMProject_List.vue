    ...
    <template v-else>
      <table>
        <tr class="text-primary">
          ...
          <th @click="sortColumn('prjName')">
            工程名称
            <span v-if="sortColumnKey === 'prjName'">
              <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
            </span>
          </th>
          ...
          <th @click="sortColumn('applicationTypeSimName')">
            应用类型
            <span v-if="sortColumnKey === 'applicationTypeSimName'">
              <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
            </span>
          </th>
          ...
          <th @click="sortColumn('functionTemplateName')">
            函数模板名
            <span v-if="sortColumnKey === 'functionTemplateName'">
              <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
            </span>
          </th>
        ...
        <tr v-for="(item, index) in items" :key="index" class="text-secondary">
          ...
          <td v-html="item.isFstLcase"></td>

          <td v-html="item.projectFileName"></td>

          <td v-html="item.isRefresh4RelaView"></td>
