 ...
 * 表名:CMProjectAppRela(0005)
 * 版本:2026.06.01(服务器:PYF-AI)
 * 日期:2026/06/01 14:20:33
 * 生成者:
 * 工程名称:AGC(0005)
...
import { CMProjectAppRela_EditAi } from '@/viewsBase/CodeMan/CMProjectAppRela_EditAi';
 ...
 *
 * 扩展说明:
 * 1、继承自 CMProjectAppRela_EditAi 基类
 * 2、可在此类中添加自定义业务逻辑
 * 3、不会被代码生成器覆盖
 */
export default class CMProjectAppRela_EditAiEx extends CMProjectAppRela_EditAi {
  /**
   * 构造函数
   * (AutoGCLib.Vue_ViewScript_EditCSAiEx_TS4TypeScript:Gen_Constructor)
   */
  constructor(objShowList: any) {
    super('CMProjectAppRela_EditAiEx', objShowList);
  }
   ...
   */
  public btnEdit_Click(strCommandName: string, key: CMProjectAppRelaKey | null): void {
    ...
    switch (strCommandName) {
      ...
      case 'UpdateRecordInTab': // 修改记录InTab
        // 🔥 单主键：检查单个关键字段
        if (key == null || key.cMProjectAppRelaId == 0) {
