  ...
  <div id="divLayout" ref="refDivLayout" class="div_layout">
    ...
    <div id="divQuery" ref="refDivQuery" class="div_query">
      ...
      >
        <tr>
          <td class="text-right">
            <label id="lblTabFeatureId_q" class="col-form-label text-right" style="width: 90px"
              >表功能Id
            </label>
          </td>
          <td class="text-left">
          ...
          <td class="text-right">
            <label id="lblTabFeatureName_q" class="col-form-label text-right" style="width: 80px"
              >表功能名
            </label>
          </td>
          <td class="text-left">
          ...
          <td class="text-right">
            <label id="lblTabId_q" class="col-form-label text-right" style="width: 60px"
              >表ID
            </label>
          </td>
          <td class="text-left">
          ...
          <td class="text-right">
            <label id="lblFeatureId_q" class="col-form-label text-right" style="width: 70px"
              >功能Id
            </label>
          </td>
          <td class="text-left">
          ...
          <td class="text-right">
            <label id="lblIsExtendedClass_q" class="col-form-label text-right" style="width: 70px"
              >扩展类?
            </label>
          </td>
          <td class="text-left">
      ...
      <ul class="nav">
        ...
        <li class="nav-item ml-3">
          <button
            ...
            class="btn btn-outline-info btn-sm text-nowrap"
            @click="btn_Click('CheckTabFeatureFld', '')"
            >检查表功能字段</button
          >
        </li>
      </ul>
