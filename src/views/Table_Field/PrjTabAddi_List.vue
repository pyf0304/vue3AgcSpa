    ...
    <template v-else>
      <table>
        <tr class="text-primary">
          ...
          <th @click="sortColumn('nodeHeight')">
            结点高
            <span>
              <i
                :class="
                  sortColumnKey === 'nodeHeight'
                    ? sortDirection === 'Asc'
                      ? 'arrow-up'
                      : 'arrow-down'
                    : 'arrow-neutral'
          ...
          <th @click="sortColumn('columnWidth')">
            结点宽
            <span>
              <i
                :class="
                  sortColumnKey === 'columnWidth'
                    ? sortDirection === 'Asc'
                      ? 'arrow-up'
                      : 'arrow-down'
                    : 'arrow-neutral'
        ...
        <tr v-for="(item, index) in items" :key="index" class="text-secondary">
          ...
          <td v-html="item.columnWidth"></td>

          <td v-html="item.nodeHeight"></td>
