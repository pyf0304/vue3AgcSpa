      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('codeFldName|Ex')">
              代码字段名
              <span>
                <i
                  :class="
                    sortColumnKey === 'codeFldName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('codeNameFldName|Ex')">
              代码名称字段名
              <span>
                <i
                  :class="
                    sortColumnKey === 'codeNameFldName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.codeTabId"></td>

            <td v-html="item.tabName"></td>

            <td v-html="item.codeTabCodeId"></td>

            <td v-html="item.codeFldName"></td>

            <td v-html="item.codeTabNameId"></td>

            <td v-html="item.codeNameFldName"></td>
