...
/** PrjTabCRUD_EditEx 的摘要说明。其中Q代表查询,U代表修改
 (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
*/
export default class PrjTabCRUD_EditEx extends PrjTabCRUD implements IShowList {
  public static CmPrjIdCache = '9991';
  public static strDivName4Tree = 'divUl';
  public static strUlName4Menu = 'ulPARENT';

  public static divName4Query = 'PrjTabCRUD_EditEx.divQuery_Main';
  ...
  BindGvCache(strType: string, strPara: string) {
    ...
    switch (strType) {
      case `${clsPrjTabEN._CurrTabName}MultiCreate`:
        //this.BindTr_PrjTable(PrjTabCRUD_EditEx.strDivName4Tree, PrjTabCRUD_EditEx.SetOnClick);
        PrjTabCRUD_EditEx.BindPrjTable(PrjTabCRUD_EditEx.strUlName4Menu, divVarSet.refDivLayout);
  ...
  public static btn_Click(strCommandName: string, strKeyId: string) {
    const objPage: PrjTabCRUD_EditEx = new PrjTabCRUD_EditEx();
    ...
    switch (strCommandName) {
      ...
      case 'Update': //修改记录
        strKeyId = PrjTabCRUD_EditEx.strTabId;
        if (strKeyId == '') {
          alert('请选择需要修改的记录！');
          return;
        }
      ...
      //    let strTabId = PrjTabCRUD_EditEx.strTabId;
      //    let strTabId = PrjTabCRUD_EditEx.strTabId;
      ...
      //    break;
      case 'DeleteTab': //删除记录
        strTabId = PrjTabCRUD_EditEx.strTabId;
      ...
      case 'ReOrder': //重序记录
        ...
        break;
      default:
        AccessBtnClickDefault(strCommandName, 'PrjTabCRUD_EditEx.btn_Click');
        alert(strMsg);
        break;
  ...
  public async PageLoadCache() {
    ...
    try {
      ...
      await PrjTabCRUD_EditEx.ChangeCmPrjId(strCmPrjId, divVarSet.refDivLayout);

      //            PrjTabCRUD_EditEx.BindPrjTable(PrjTabCRUD_EditEx.strUlName4Menu);
    } catch (e: any) {
...
*/
  ...
  public static CombinePrjTabConditionObj(): clsPrjTabEN {
    ...
    try {
      const objThisPage = new PrjTabCRUD_EditEx();
...
*/
  ...
  public static main_Click(strKey: string) {
    PrjTabCRUD_EditEx.strTabId = strKey;
    ...
    PrjTabCRUD_EditEx.SetSubNoSelected4All('');
    PrjTab_EditEx.TabIdCache = strKey;
    console.log(strKey);
  }
  ...
  public static SetSubNoSelected4All(strKey: string) {
    const objDivUL: HTMLDivElement = <HTMLDivElement>(
      document.getElementById(PrjTabCRUD_EditEx.strDivName4Tree)
    );
  ...
  public static sub_Click(strKey: string, strTabId: string) {
    //alert("sub_Click");
    PrjTabCRUD_EditEx.strTabId = strKey;
    PrjTabCRUD_EditEx.strTabId = strTabId;
    ...
    PrjTabCRUD_EditEx.SetSubNoSelected4All(strKey);
    console.log('tabId:(In sub_Click)', strKey);
    PrjTabCRUD_EditEx.strTabId = strKey;
    PrjTabCRUD_EditEx.strTabId = strTabId;

    //PrjTabCRUD_EditEx.ShowPrjTableEdit(strKey, strTabId);
    console.log(strKey);
  }
  ...
  public async btnShowQuery_Click() {
    // const divQuery = <HTMLDivElement>document.getElementById('PrjTabCRUD_EditEx.divQuery_Main');
    ...
    //await this.BindTr_PrjTable(PrjTabCRUD_EditEx.strDivName4Tree, PrjTabCRUD_EditEx.SetOnClick);
  }
  /** 根据条件获取相应的对象列表
...
*/
  ...
  public static async BindPrjTable(strUlRoot: string, divLayout: HTMLDivElement) {
    ...
    const thisPage = new PrjTabCRUD_EditEx();
    ...
    for (const objPrjTab of arrPrjTabObjLst) {
      ...
      (function (strTabId1) {
        A_Tab.onclick = function () {
          PrjTabCRUD_EditEx.main_Click(strTabId1);
        };
      })(objPrjTab.tabId);
...

      {
        ...
        //    A1.onclick = (function () {
        //        PrjTabCRUD_EditEx.sub_Click(strTabId1, strTabId1);
        //    });
        //})(strTabId, strTabId);
  ...
  private static async BindSubMenu_Constraint(
    ...
    for (const objInFor of arrPrjConstraintExObjLst) {
      ...
      await vPrjConstraint_SimEx_FuncMapByFldName(clsPrjConstraintENEx.con_TabName, objInFor);
    }
    ...
    for (const objPrjConstraint of arrPrjConstraintExObjLst) {
      ...
      (function (strTabId1, strFldId1, divLayout) {
        img_Delete.onclick = function () {
          PrjTabCRUD_EditEx.btnDeletePrjConstraint_Click(strTabId1, strFldId1, divLayout);
        };
      })(strTabId, strPrjConstraintId, divLayout);
      ...
      (function (strPrjConstraintId, strTabId) {
        img_Update.onclick = function () {
          PrjTabCRUD_EditEx.btnEditPrjConstraint_Click(strPrjConstraintId, strTabId);
        };
  ...
  private static async BindSubMenu_TabFeature(
    ...
    for (const objTabFeature of arrTabFeatureExObjLst) {
      ...
      (function (strTabId1, strFldId1, divLayout) {
        img_Delete.onclick = function () {
          PrjTabCRUD_EditEx.btnDeleteTabFeature_Click(strTabId1, strFldId1, divLayout);
        };
      ...
      (function (strTabFeatureId, strTabId) {
        img_Update.onclick = function () {
          PrjTabCRUD_EditEx.btnEditTabFeature_Click(strTabFeatureId, strTabId);
        };
  ...
  private static async BindSubMenu_TabFunctionProp(
    ...
    for (const objTabFunctionProp of arrTabFunctionPropExObjLst) {
      ...
      (function (lngMid1, strPrjId1, divLayout) {
        img_Delete.onclick = function () {
          PrjTabCRUD_EditEx.btnDeleteTabFunctionProp_Click(lngMid1, strPrjId1, divLayout);
        };
      ...
      (function (lngMid1, strTabId) {
        img_Update.onclick = function () {
          PrjTabCRUD_EditEx.btnEditTabFunctionProp_Click(lngMid1, strTabId);
        };
  ...
  private static async BindSubMenu_FldLstB(
    ...
    //let arrPrjTabFldObjLst_Sel = arrPrjTabFldObjLst.filter(x => x.tabId == strTabId);
    ...
    for (const objPrjTabFld of arrPrjTabFldExObjLst) {
      ...
      I1.className = 'icon-font';
      const strLinkFile = ''; // await this.GetLinkFile(strTabId, strTabId);
      let strHref = `${strLinkFile}`;
      ...
      (function (strTabId1, strFldId1, divLayout) {
        img_Delete.onclick = function () {
          PrjTabCRUD_EditEx.btnDeletePrjTabFld_Click(strTabId1, strFldId1, divLayout);
        };
      ...
      (function (strMId, strTabId) {
        img_Update.onclick = function () {
          PrjTabCRUD_EditEx.btnEditPrjTabFld_Click(strMId, strTabId);
        };
  ...
  public static GetButton_AddNew(strTabId: string): HTMLButtonElement {
    ...
    //        PrjTabCRUD_EditEx.btnAddNewTab_Click(strTabId1);
    //    });
    //})(strTabId);
  ...
  public async BindUl_CmPrjId(strPrjId: string) {
    ...
    for (const objCMProject of arrCMProject) {
      ...
      (function (strCmPrjId, divLayout) {
        A1.onclick = function () {
          PrjTabCRUD_EditEx.ChangeCmPrjId(strCmPrjId, divLayout);
        };
  ...
  public static async ChangeCmPrjId(strCmPrjId: string, divLayout: HTMLDivElement) {
    if (PrjTabCRUD_EditEx.CmPrjIdCache == strCmPrjId) return;
    ...
    PrjTabCRUD_EditEx.CmPrjIdCache = strCmPrjId;

    PrjTabCRUD_EditEx.BindPrjTable(PrjTabCRUD_EditEx.strUlName4Menu, divLayout);
  }
  /** 删除记录
...
*/
  ...
  public static async BindPrjTableBak(strUlRoot: string) {
    ...
    UlParent.innerText = '';
    const strPrjId = clsPrivateSessionStorage.currSelPrjId;
    const strCmPrjId = PrjTabCRUD_EditEx.CmPrjIdCache;
    // const objPrjTabCond = this.CombinePrjTabConditionObj();
    const objThisPage = new PrjTabCRUD_EditEx();
    let strWhereCond = await objThisPage.CombinePrjTabCondition();
    strWhereCond += Format(
  ...
  public get tabName_q(): string {
    const strValue = GetInputValueInDivObj(
      GetUniDivInDoc('PrjTabCRUD_EditEx.divQuery_Main'),
      'txtTabName_q',
    );
    if (strValue == undefined) return '';
...
function EditPrjTab(strTabId: string) {
  PrjTabCRUD_EditEx.vuebtn_Click('EditPrjTab', strTabId);
}
