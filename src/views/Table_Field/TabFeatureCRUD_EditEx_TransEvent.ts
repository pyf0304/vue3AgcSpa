...
/** TabFeatureCRUD_EditEx_TransEvent 的摘要说明。其中Q代表查询,U代表修改
 (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
*/
export class TabFeatureCRUD_EditEx_TransEvent extends TabFeatureCRUD implements IShowList {
  ...
  async BindGvCache(strType: string, strPara: string) {
    console.log(strType, strPara);
    const divList = GetDivObjInDivObjN(divVarSet.refDivLayout, 'divTabFeatureLst0172');
  ...
  public static async btn_Click(strCommandName: string, strKeyId: string) {
    const objPage: TabFeatureCRUD_EditEx_TransEvent = new TabFeatureCRUD_EditEx_TransEvent();
  ...
  public async BindLi_TabFeatureLst(strTabId: string, divList: HTMLDivElement) {
    ...
    //const strCmPrjId = TabFeatureCRUD_EditEx_TransEvent.CmPrjIdCache;
    //const intFldId = 0;
  ...
  public GetUl_CreateFunc(strFeatureId: string, strTabId: string): HTMLUListElement {
    ...
    (function (strFeatureId1, strTabId1) {
      btnCreateFunc.onclick = function () {
        TabFeatureCRUD_EditEx_TransEvent.btnCreateBindDdlFunc(strFeatureId1, strTabId1);
      };
  ...
  public static async btnGeneCode(strTabFeatureId: string) {
    try {
      ...
      TabFeatureCRUD_EditEx_TransEvent.ShowCode(
        strCode_CSharp,
        strCode_TypeScript,
        strTabFeatureId,
      );
  ...
  public GetButton_CreateTabFeature(strFldId: string, strTabId: string): HTMLButtonElement {
    ...
    (function (strFldId, strTabId1) {
      btnCreateFunc.onclick = function () {
        TabFeatureCRUD_EditEx_TransEvent.btnCreateBindDdlFunc(strFldId, strTabId1);
      };
    })(strFldId, strTabId);
  ...
  public GetButton_UpdateTabFeature(strTabFeatureId: string): HTMLButtonElement {
    ...
    (function (strTabFeatureId1) {
      btnUpdateteTabFeature.onclick = function () {
        TabFeatureCRUD_EditEx_TransEvent.btnUpdateTabFeature(strTabFeatureId1);
      };
    })(strTabFeatureId);
  ...
  public GetButton_EditComboBox(strTabFeatureId: string): HTMLButtonElement {
    ...
    (function (strTabFeatureId1) {
      btnUpdateteTabFeature.onclick = function () {
        TabFeatureCRUD_EditEx_TransEvent.btnEditComboBox(strTabFeatureId1);
      };
    })(strTabFeatureId);
  ...
  public GetButton_GeneCode(strTabFeatureId: string): HTMLButtonElement {
    ...
    (function (strTabFeatureId1) {
      btnGeneCode.onclick = function () {
        TabFeatureCRUD_EditEx_TransEvent.btnGeneCode(strTabFeatureId1);
      };
    })(strTabFeatureId);
  ...
  public static async btnCopyNode_Click(strTabFeatureId: string, divLayout: HTMLDivElement) {
    try {
      ...
      const divList = GetDivObjInDivObjN(divLayout, 'divTabFeatureLst0172');
      if (divList == null) return;
      const objTabFeatureCRUD_EditEx = new TabFeatureCRUD_EditEx_TransEvent();
  ...
  public GetButton_CopyNode(strTabFeatureId: string): HTMLButtonElement {
    ...
    (function (strTabFeatureId1, divLayout) {
      btnCopyNode.onclick = function () {
        TabFeatureCRUD_EditEx_TransEvent.btnCopyNode_Click(strTabFeatureId1, divLayout);
      };
  ...
  public GetButton_DelNode(strTabFeatureId: string): HTMLButtonElement {
    ...
    (function (strTabFeatureId1, divLayout) {
      btnDelNode.onclick = function () {
        TabFeatureCRUD_EditEx_TransEvent.btnDelRecordEx_Click(strTabFeatureId1, divLayout);
      };
    })(strTabFeatureId, divVarSet.refDivLayout);
  ...
  public get featureId(): string {
    return TabFeatureCRUD_EditEx_TransEvent.GetPropValue('featureId');
  }
