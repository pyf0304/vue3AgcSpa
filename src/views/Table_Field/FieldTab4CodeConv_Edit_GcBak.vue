  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function BindDdl4EditRegionInDiv() {
        ...
        if (strTabId_Static == '') {
          const strMsg = Format('FieldTab4CodeConvEdit.TabId_Static.value为空,请检查！');
      ...
      async function ShowDataFromFieldTab4CodeConvObj(
        ...
        codeTabId.value = pobjFieldTab4CodeConvEN.codeTabId; // 代码表Id
        codeTabCodeId.value = pobjFieldTab4CodeConvEN.codeTabCodeId; // 代码Id
        codeTabNameId.value = pobjFieldTab4CodeConvEN.codeTabNameId; // 代码_名Id
      }
