      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('fieldTypeName|Ex')">
              字段类型
              <span>
                <i
                  :class="
                    sortColumnKey === 'fieldTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('tabNum|Ex')">
              表数
              <span>
                <i
                  :class="
                    sortColumnKey === 'tabNum|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.fldId"></td>

            <td v-html="item.fldName"></td>
            ...
            <td v-html="item.fldLength"></td>

            <td v-html="item.fldPrecision"></td>

            <td v-html="item.isNull"></td>

            <td v-html="item.isPrimaryKey"></td>

            <td v-html="item.isOnlyOne"></td>

            <td v-html="item.maxValue"></td>

            <td v-html="item.minValue"></td>

            <td v-html="item.defaultValue"></td>

            <td v-html="item.tabNum"></td>

            <td v-html="item.isNeedTransCode"></td>
