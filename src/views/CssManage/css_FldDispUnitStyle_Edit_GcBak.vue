          ...
          <tr id="trFldDispUnitStyleContent">
            ...
            <td class="text-left">
              <input
                ...
                v-model="fldDispUnitStyleContent"
                class="form-control form-control-sm"
                style="width: 400px"
              />
            </td>
