/**
 * 类名:CMProjectAppRela_Edit(界面:CMProjectAppRelaCRUD,00050340)
 * 表名:CMProjectAppRela(00050600)
 * 版本:2025.05.03.1(服务器:WIN-SRV103-116)
 * 日期:2025/05/08 11:50:41
 * 生成者:
 工程名称:AGC(0005)
...
import {
  ...
  CMProjectAppRela_GetUniCondStr,
...
/** CMProjectAppRela_Edit 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScript_EditCS_TS4TypeScript:GeneCode)
 **/
export abstract class CMProjectAppRela_Edit {
  ...
  public static objPageEdit: CMProjectAppRela_Edit;
  public static objPageEdit2: CMProjectAppRela_Edit;
  public static objPageEdit3: CMProjectAppRela_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList | null) {
    ...
    if (CMProjectAppRela_Edit.SetPageEdit(this, 1) == true) return;
    if (CMProjectAppRela_Edit.SetPageEdit(this, 2) == true) return;
    if (CMProjectAppRela_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (CMProjectAppRela_Edit.objPageEdit == null) {
          CMProjectAppRela_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = CMProjectAppRela_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (CMProjectAppRela_Edit.objPageEdit2 == null) {
          CMProjectAppRela_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = CMProjectAppRela_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            CMProjectAppRela_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (CMProjectAppRela_Edit.objPageEdit3 == null) {
          CMProjectAppRela_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = CMProjectAppRela_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            CMProjectAppRela_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (CMProjectAppRela_Edit.objPageEdit != null) {
      const strClassNameOld = CMProjectAppRela_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return CMProjectAppRela_Edit.objPageEdit;
    }
    if (CMProjectAppRela_Edit.objPageEdit2 != null) {
      const strClassNameOld = CMProjectAppRela_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return CMProjectAppRela_Edit.objPageEdit2;
    }
    if (CMProjectAppRela_Edit.objPageEdit3 != null) {
      const strClassNameOld = CMProjectAppRela_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return CMProjectAppRela_Edit.objPageEdit3;
    }
    return null;
  }
   ...
   **/
  public async btnUpdateRecordInTab_Click(lngCMProjectAppRelaId: number) {
    ...
    try {
      ...
      const bolIsSuccess = await this.ShowDialog_CMProjectAppRela(this.opType);
      if (bolIsSuccess == false) return;
      const lngKeyId = lngCMProjectAppRelaId;
   ...
   **/
  public async btnUpdateRecord_Click(lngCMProjectAppRelaId: number) {
      ...
      switch (strCommandText) {
        ...
        case '确认修改':
          ...
          if (returnBool == true) {
            ...
            if (this.iShowList != null)
              this.iShowList.BindGvCache(clsCMProjectAppRelaEN._CurrTabName, this.keyId.toString());
          }
          break;
        default:
          strMsg = Format(
  ...
  public async AddNewRecord() {
    ...
    //wucCMProjectAppRelaB1.cMProjectAppRelaId = CMProjectAppRelaGetMaxStrId_S();
  }
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.cMProjectAppRelaId = await CMProjectAppRela_GetMaxStrIdAsync();
  }
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objCMProjectAppRelaEN);
   ...
   **/
  public async CheckUniCond4Add(objCMProjectAppRelaEN: clsCMProjectAppRelaEN): Promise<boolean> {
   ...
   **/
  public async CheckUniCond4Update(objCMProjectAppRelaEN: clsCMProjectAppRelaEN): Promise<boolean> {
   ...
   * @param lngCMProjectAppRelaId: 表记录的关键字,显示该表关键字的内容
   **/
  public async ShowData(lngCMProjectAppRelaId: number) {
   ...
   **/
  public async UpdateRecord(lngCMProjectAppRelaId: number): Promise<boolean> {
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Update(objCMProjectAppRelaEN);
      if (bolIsExistCond == false) {
        return false;
      }
