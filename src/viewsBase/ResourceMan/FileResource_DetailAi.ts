...
await FileResourceEx_FuncMapByFldName(clsFileResourceENEx.con_CodeTypeSimName, objFileResourceENEx);
await FileResourceEx_FuncMapByFldName(clsFileResourceENEx.con_TabName, objFileResourceENEx);
await FileResourceEx_FuncMapByFldName(clsFileResourceENEx.con_PrjFileTypeName, objFileResourceENEx);
if (refFileResource_DetailAi.value == null)
{
