/**
 * 类名:PrjTab_U(界面:PrjTab_U,00050303)
 * 表名:PrjTab(00050009)
 * 版本:2025.05.12.1(服务器:WIN-SRV103-116)
 * 日期:2025/05/15 01:35:48
 * 生成者:
 工程名称:AGC(0005)
 ...
 **/
//import $ from "jquery";
import { SetLabelHtmlByIdInDivObj, GetLabelHtmlInDivObj } from '@/ts/PubFun/clsCommFunc4Ctrl';
import { divVarSet } from '@/views/Table_Field/PrjTab_UVueShare';
import { clsPrjTabEN } from '@/ts/L0Entity/Table_Field/clsPrjTabEN';
import { clsPager } from '@/ts/PubFun/clsPager';
import { ListPara, clsOperateList } from '@/ts/PubFun/clsOperateList';
import { Format } from '@/ts/PubFun/clsString';
import { GetObjKeys } from '@/ts/PubFun/clsCommFunc4Web';
/** PrjTab_U 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScriptCS_TS4TypeScript:GeneCode)
 **/
export abstract class PrjTab_U implements clsOperateList {
  ...
  public static objPageCRUD: PrjTab_U;
  public static sortFunStatic: (ascOrDesc: string) => (x: any, y: any) => number;
  constructor() {
    this.listPara = new ListPara(divVarSet.refDivLayout, divVarSet.refDivList);
    PrjTab_U.objPageCRUD = this;
