/**
 * 类名:ViewInfo_U(界面:ViewInfo_U,00050280)
 * 表名:ViewInfo(00050006)
 * 版本:2025.05.12.1(服务器:WIN-SRV103-116)
 * 日期:2025/05/15 01:36:06
 * 生成者:
 工程名称:AGC(0005)
...
/** ViewInfo_U 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScriptCS_TS4TypeScript:GeneCode)
 **/
export abstract class ViewInfo_U implements clsOperateList {
  ...
  public static objPageCRUD: ViewInfo_U;
  public static sortFunStatic: (ascOrDesc: string) => (x: any, y: any) => number;
  constructor() {
    this.listPara = new ListPara(divVarSet.refDivLayout, divVarSet.refDivList);
    ViewInfo_U.objPageCRUD = this;
  ...
  public async BindGv_ViewInfo4Func(divList: HTMLDivElement) {
    ...
    try {
      ...
      if (ViewInfo_U.sortFunStatic != undefined) {
        strSortFun = ViewInfo_U.sortFunStatic(viewVarSet.ascOrDesc4SortFun);
      }
  ...
  public async SortBy(objAnchorElement: any) {
    ...
    ViewInfo_U.sortFunStatic = sortFun;
    await this.BindGv_ViewInfo4Func(this.listPara.listDiv);
  }
