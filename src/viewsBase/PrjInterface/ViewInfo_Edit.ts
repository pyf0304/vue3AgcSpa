/**
 * 类名:ViewInfo_Edit(界面:ViewInfoCRUD,00050234)
 * 表名:ViewInfo(00050006)
 * 版本:2025.05.03.1(服务器:WIN-SRV103-116)
 * 日期:2025/05/08 11:51:31
 * 生成者:
 工程名称:AGC(0005)
...
/** ViewInfo_Edit 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScript_EditCS_TS4TypeScript:GeneCode)
 **/
export abstract class ViewInfo_Edit {
  ...
  public static objPageEdit: ViewInfo_Edit;
  public static objPageEdit2: ViewInfo_Edit;
  public static objPageEdit3: ViewInfo_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList | null) {
    ...
    if (ViewInfo_Edit.SetPageEdit(this, 1) == true) return;
    if (ViewInfo_Edit.SetPageEdit(this, 2) == true) return;
    if (ViewInfo_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (ViewInfo_Edit.objPageEdit == null) {
          ViewInfo_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = ViewInfo_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (ViewInfo_Edit.objPageEdit2 == null) {
          ViewInfo_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = ViewInfo_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            ViewInfo_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (ViewInfo_Edit.objPageEdit3 == null) {
          ViewInfo_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = ViewInfo_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            ViewInfo_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (ViewInfo_Edit.objPageEdit != null) {
      const strClassNameOld = ViewInfo_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return ViewInfo_Edit.objPageEdit;
    }
    if (ViewInfo_Edit.objPageEdit2 != null) {
      const strClassNameOld = ViewInfo_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return ViewInfo_Edit.objPageEdit2;
    }
    if (ViewInfo_Edit.objPageEdit3 != null) {
      const strClassNameOld = ViewInfo_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return ViewInfo_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_ViewInfo() {
    if (ViewInfo_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      refViewInfo_Edit.value.hideDialog();
    }
  }
  ...
  public async ShowDialog_ViewInfo(strOp: string): Promise<boolean> {
    ...
    if (ViewInfo_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (refViewInfo_Edit.value == null) {
        const strMsg = Format(
      ...
      await refViewInfo_Edit.value.showDialog(this);
    }
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    let objViewInfoEN;
    try {
      objViewInfoEN = await refViewInfo_Edit.value.GetEditDataViewInfoObj();
    } catch (e) {
      const strMsg = Format(
        '从界面获取数据不成功,{0}.(in {1}.{2})',
        e,
  ...
  public async ShowData(strViewId: string) {
    ...
    //3、用提供的关键字初始化一个类对象；
    refViewInfo_Edit.value.ShowDataFromViewInfoObj(objViewInfoEN);
  }
  ...
  public async UpdateRecord(strViewId: string): Promise<boolean> {
    ...
    try {
      ...
      await refViewInfo_Edit.value.ShowDataFromViewInfoObj(objViewInfoEN);
  ...
  public set btnCancelViewInfo(value: string) {
    refViewInfo_Edit.value.strCancelButtonText = value;
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitViewInfo(): string {
    const strValue = refViewInfo_Edit.value.strSubmitButtonText;
    return strValue;
  }
  /**
  ...
  public set btnSubmitViewInfo(value: string) {
    refViewInfo_Edit.value.strSubmitButtonText = value;
  }
}
