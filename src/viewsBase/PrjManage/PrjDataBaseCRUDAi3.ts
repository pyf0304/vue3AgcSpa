...
/**
 * Ai3版基类：
 * 在Ai2(列配置单一来源)基础上，配合Ai3查询schema实现查询配置单一来源。
 */
export abstract class PrjDataBaseCRUDAi3 extends AIOperateListBase implements clsOperateList {
  ...
  public async BindGv_PrjDataBase4Func(divList: HTMLDivElement) {
    ...
    try {
      ...
      const currentCtor = this.constructor as typeof PrjDataBaseCRUDAi3;
