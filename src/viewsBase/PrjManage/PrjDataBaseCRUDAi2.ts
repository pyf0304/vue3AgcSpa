 ...
 * 2) 列表与导出都使用同一份列规格
 */
export abstract class PrjDataBaseCRUDAi2 extends AIOperateListBase implements clsOperateList {
  ...
  public async BindGv_PrjDataBase4Func(divList: HTMLDivElement) {
    ...
    try {
      ...
      const currentCtor = this.constructor as typeof PrjDataBaseCRUDAi2;
