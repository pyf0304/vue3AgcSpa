...
export const PRJ_DATABASE_COMMAND_SPECS_AI4: Array<PrjDataBaseCommandSpecAi> = [
  {
    id: 'query',
    region: 'query',
    text: '查询',
...
/** 获取查询区命令。 */
export function getQueryCommandsAi4(): Array<PrjDataBaseCommandSpecAi> {
  return PRJ_DATABASE_COMMAND_SPECS_AI4.filter((x) => x.region === 'query' && x.visible !== false);
}

/** 获取功能区命令。 */
export function getFeatureCommandsAi4(): Array<PrjDataBaseCommandSpecAi> {
