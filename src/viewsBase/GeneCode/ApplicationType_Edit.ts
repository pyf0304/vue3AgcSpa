...
/** ApplicationType_Edit 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScript_EditCS_TS4TypeScript:GeneCode)
 **/
export abstract class ApplicationType_Edit {
  ...
  public static objPageEdit: ApplicationType_Edit;
  public static objPageEdit2: ApplicationType_Edit;
  public static objPageEdit3: ApplicationType_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList | null) {
    ...
    if (ApplicationType_Edit.SetPageEdit(this, 1) == true) return;
    if (ApplicationType_Edit.SetPageEdit(this, 2) == true) return;
    if (ApplicationType_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (ApplicationType_Edit.objPageEdit == null) {
          ApplicationType_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = ApplicationType_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (ApplicationType_Edit.objPageEdit2 == null) {
          ApplicationType_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = ApplicationType_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            ApplicationType_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (ApplicationType_Edit.objPageEdit3 == null) {
          ApplicationType_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = ApplicationType_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            ApplicationType_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (ApplicationType_Edit.objPageEdit != null) {
      const strClassNameOld = ApplicationType_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return ApplicationType_Edit.objPageEdit;
    }
    if (ApplicationType_Edit.objPageEdit2 != null) {
      const strClassNameOld = ApplicationType_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return ApplicationType_Edit.objPageEdit2;
    }
    if (ApplicationType_Edit.objPageEdit3 != null) {
      const strClassNameOld = ApplicationType_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return ApplicationType_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_ApplicationType() {
    if (ApplicationType_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
  ...
  public async btnUpdateRecordInTab_Click(intApplicationTypeId: number) {
    ...
    try {
      ...
      const bolIsSuccess = await this.ShowDialog_ApplicationType(this.opType);
      if (bolIsSuccess == false) return;
      const lngKeyId = intApplicationTypeId;
    ...
    try {
      ...
      switch (strCommandText) {
          ...
          if (['02', '03', '06'].indexOf(clsApplicationTypeEN.PrimaryTypeId) > -1) {
            ...
            if (returnKeyId != 0) {
              ...
              if (this.iShowList != null)
                this.iShowList.BindGvCache(clsApplicationTypeEN._CurrTabName, '');
            }
          } else {
        ...
        case '确认修改':
          ...
          strInfo += '(In ApplicationType_Edit.btnSubmit_Click)';
          //显示信息框
          //console.log(strInfo);
          alert(strInfo);
          if (returnBool == true) {
  ...
  public async AddNewRecord() {
    ...
    //wucApplicationTypeB1.applicationTypeId = ApplicationTypeGetMaxStrId_S();
  }
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.applicationTypeId = await ApplicationType_GetMaxStrIdAsync();
  }
   ...
   * @param intApplicationTypeId: 表记录的关键字,显示该表关键字的内容
   **/
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    objApplicationTypeEN.SetApplicationTypeId(Number(this.keyId));
