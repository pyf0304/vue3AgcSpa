/**
 * 类名:DetailRegionFlds_Edit(界面:DetailRegionFldsCRUD,00050293)
 * 表名:DetailRegionFlds(00050544)
 * 版本:2025.05.03.1(服务器:WIN-SRV103-116)
 * 日期:2025/05/08 11:50:50
 * 生成者:
 工程名称:AGC(0005)
...
import {
  ...
  DetailRegionFlds_GetUniCondStr,
  DetailRegionFlds_IsExistRecordAsync,
  DetailRegionFlds_GetUniCondStr4Update,
  DetailRegionFlds_AddNewRecordWithReturnKeyAsync,
  DetailRegionFlds_IsExistAsync,
  DetailRegionFlds_GetObjBymIdAsync,
  DetailRegionFlds_CheckProperty4Update,
  DetailRegionFlds_UpdateRecordAsync,
  DetailRegionFlds_EditRecordExAsync,
...
/** DetailRegionFlds_Edit 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScript_EditCS_TS4TypeScript:GeneCode)
 **/
export abstract class DetailRegionFlds_Edit {
  ...
  public static objPageEdit: DetailRegionFlds_Edit;
  public static objPageEdit2: DetailRegionFlds_Edit;
  public static objPageEdit3: DetailRegionFlds_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList | null) {
    ...
    if (DetailRegionFlds_Edit.SetPageEdit(this, 1) == true) return;
    if (DetailRegionFlds_Edit.SetPageEdit(this, 2) == true) return;
    if (DetailRegionFlds_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (DetailRegionFlds_Edit.objPageEdit == null) {
          DetailRegionFlds_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = DetailRegionFlds_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (DetailRegionFlds_Edit.objPageEdit2 == null) {
          DetailRegionFlds_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = DetailRegionFlds_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            DetailRegionFlds_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (DetailRegionFlds_Edit.objPageEdit3 == null) {
          DetailRegionFlds_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = DetailRegionFlds_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            DetailRegionFlds_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (DetailRegionFlds_Edit.objPageEdit != null) {
      const strClassNameOld = DetailRegionFlds_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return DetailRegionFlds_Edit.objPageEdit;
    }
    if (DetailRegionFlds_Edit.objPageEdit2 != null) {
      const strClassNameOld = DetailRegionFlds_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return DetailRegionFlds_Edit.objPageEdit2;
    }
    if (DetailRegionFlds_Edit.objPageEdit3 != null) {
      const strClassNameOld = DetailRegionFlds_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return DetailRegionFlds_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_DetailRegionFlds() {
    if (DetailRegionFlds_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      refDetailRegionFlds_Edit.value.hideDialog();
    }
  }
  ...
  public async ShowDialog_DetailRegionFlds(strOp: string): Promise<boolean> {
    ...
    if (DetailRegionFlds_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (refDetailRegionFlds_Edit.value == null) {
        const strMsg = Format(
      ...
      await refDetailRegionFlds_Edit.value.showDialog(this);
    }
    if (strOp === 'Add' || strOp === 'AddWithMaxId') {
      this.btnSubmitDetailRegionFlds = '确认添加';
      this.btnCancelDetailRegionFlds = '取消添加';
    } else if (strOp === 'Update') {
      this.btnSubmitDetailRegionFlds = '确认修改';
      this.btnCancelDetailRegionFlds = '取消修改';
    }
    return true;
  }
  ...
  public async btnAddNewRecord_Click() {
    ...
    try {
      this.opType = 'Add';
      const bolIsSuccess = await this.ShowDialog_DetailRegionFlds(this.opType);
  ...
  public async btnSubmit_Click() {
    ...
    const strCommandText: string = this.btnSubmitDetailRegionFlds;
    try {
      ...
      switch (strCommandText) {
          ...
          if (['02', '03', '06'].indexOf(clsDetailRegionFldsEN.PrimaryTypeId) > -1) {
            ...
            if (returnKeyId != 0) {
              ...
              if (this.iShowList != null)
                this.iShowList.BindGvCache(clsDetailRegionFldsEN._CurrTabName, '');
            }
          } else {
        ...
        case '确认修改':
          ...
          if (returnBool == true) {
            ...
            if (this.iShowList != null)
              this.iShowList.BindGvCache(clsDetailRegionFldsEN._CurrTabName, this.keyId.toString());
          }
          break;
        default:
          strMsg = Format(
  ...
  public async AddNewRecord() {
    ...
    refDetailRegionFlds_Edit.value.Clear();
    //wucDetailRegionFldsB1.mId = DetailRegionFldsGetMaxStrId_S();
  }
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.mId = await DetailRegionFlds_GetMaxStrIdAsync();
  }
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objDetailRegionFldsEN);
      ...
      if (returnBool == true) {
        ...
        const strInfo = `添加[详细区域字段(DetailRegionFlds)]记录成功!`;
        //显示信息框
   ...
   **/
  public async CheckUniCond4Add(objDetailRegionFldsEN: clsDetailRegionFldsEN): Promise<boolean> {
   ...
   **/
  public async CheckUniCond4Update(objDetailRegionFldsEN: clsDetailRegionFldsEN): Promise<boolean> {
  ...
  public async AddNewRecordWithReturnKeySave(): Promise<number> {
    ...
    try {
      ...
      const responseKeyId = await DetailRegionFlds_AddNewRecordWithReturnKeyAsync(
        objDetailRegionFldsEN,
      );
      const returnKeyId: string = responseKeyId;
      if (IsNullOrEmpty(returnKeyId) == false) {
        objDetailRegionFldsEN.mId = Number(returnKeyId);
        DetailRegionFlds_ReFreshCache(RegionId_Static.value);
        const strInfo = `添加[详细区域字段(DetailRegionFlds)]记录成功!`;
        //显示信息框
        if (this.isShowMsg == true) alert(strInfo);
  ...
  public async ShowData(lngmId: number) {
    ...
    //2、检查该关键字的记录是否存在,如果不存在就返回不显示；
    let objDetailRegionFldsEN = new clsDetailRegionFldsEN();
    try {
      const returnBool = await DetailRegionFlds_IsExistAsync(lngmId);
      if (returnBool == false) {
    ...
    try {
      const objDetailRegionFldsENConst = await DetailRegionFlds_GetObjBymIdAsync(lngmId);
      if (objDetailRegionFldsENConst == null) {
        const strMsg = Format(
      ...
      objDetailRegionFldsEN = objDetailRegionFldsENConst;
    } catch (e) {
      const strMsg = Format(
    ...
    //3、用提供的关键字初始化一个类对象；
    refDetailRegionFlds_Edit.value.ShowDataFromDetailRegionFldsObj(objDetailRegionFldsEN);
  }
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    try {
      ...
      if (returnBool == true) {
        DetailRegionFlds_ReFreshCache(RegionId_Static.value);
        DetailRegionFlds_DeleteKeyIdCache(RegionId_Static.value, this.keyId);
      }
      return returnBool;
    } catch (e) {
      const strMsg = Format(
  ...
  public async EditRecordExSave(): Promise<boolean> {
    ...
    try {
      ...
      const returnBool = await DetailRegionFlds_EditRecordExAsync(objDetailRegionFldsEN);
      if (returnBool == true) {
        DetailRegionFlds_ReFreshCache(RegionId_Static.value);
      }
      return returnBool;
  ...
  public set btnCancelDetailRegionFlds(value: string) {
    refDetailRegionFlds_Edit.value.strCancelButtonText = value;
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitDetailRegionFlds(): string {
    const strValue = refDetailRegionFlds_Edit.value.strSubmitButtonText;
    return strValue;
  }
  /**
   * 设置确定按钮的标题(Used In AddNewRecord())
   **/
  public set btnSubmitDetailRegionFlds(value: string) {
    refDetailRegionFlds_Edit.value.strSubmitButtonText = value;
  }
}
