/**
 * 类名:FeatureRegionFlds_Edit(界面:FeatureRegionFldsCRUD,00050127)
 * 表名:FeatureRegionFlds(00050452)
 * 版本:2025.05.03.1(服务器:WIN-SRV103-116)
 * 日期:2025/05/08 11:50:58
 * 生成者:
 工程名称:AGC(0005)
 ...
 **/
export abstract class FeatureRegionFlds_Edit {
  ...
  public static objPageEdit: FeatureRegionFlds_Edit;
  public static objPageEdit2: FeatureRegionFlds_Edit;
  public static objPageEdit3: FeatureRegionFlds_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList | null) {
    ...
    if (FeatureRegionFlds_Edit.SetPageEdit(this, 1) == true) return;
    if (FeatureRegionFlds_Edit.SetPageEdit(this, 2) == true) return;
    if (FeatureRegionFlds_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (FeatureRegionFlds_Edit.objPageEdit == null) {
          FeatureRegionFlds_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = FeatureRegionFlds_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (FeatureRegionFlds_Edit.objPageEdit2 == null) {
          FeatureRegionFlds_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = FeatureRegionFlds_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            FeatureRegionFlds_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (FeatureRegionFlds_Edit.objPageEdit3 == null) {
          FeatureRegionFlds_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = FeatureRegionFlds_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            FeatureRegionFlds_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (FeatureRegionFlds_Edit.objPageEdit != null) {
      const strClassNameOld = FeatureRegionFlds_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return FeatureRegionFlds_Edit.objPageEdit;
    }
    if (FeatureRegionFlds_Edit.objPageEdit2 != null) {
      const strClassNameOld = FeatureRegionFlds_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return FeatureRegionFlds_Edit.objPageEdit2;
    }
    if (FeatureRegionFlds_Edit.objPageEdit3 != null) {
      const strClassNameOld = FeatureRegionFlds_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return FeatureRegionFlds_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_FeatureRegionFlds() {
    if (FeatureRegionFlds_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      refFeatureRegionFlds_Edit.value.hideDialog();
    }
  }
  ...
  public async ShowDialog_FeatureRegionFlds(strOp: string): Promise<boolean> {
    ...
    if (FeatureRegionFlds_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (refFeatureRegionFlds_Edit.value == null) {
        const strMsg = Format(
      ...
      await refFeatureRegionFlds_Edit.value.showDialog(this);
    }
  ...
  public async AddNewRecord() {
    ...
    refFeatureRegionFlds_Edit.value.Clear();
  ...
  public async UpdateRecord(strViewFeatureId: string): Promise<boolean> {
    ...
    try {
      ...
      await refFeatureRegionFlds_Edit.value.ShowDataFromFeatureRegionFldsObj(
        objFeatureRegionFldsEN,
      );
  ...
  public set btnCancelFeatureRegionFlds(value: string) {
    refFeatureRegionFlds_Edit.value.strCancelButtonText = value;
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitFeatureRegionFlds(): string {
    const strValue = refFeatureRegionFlds_Edit.value.strSubmitButtonText;
    return strValue;
  }
  /**
  ...
  public set btnSubmitFeatureRegionFlds(value: string) {
    refFeatureRegionFlds_Edit.value.strSubmitButtonText = value;
  }
}
