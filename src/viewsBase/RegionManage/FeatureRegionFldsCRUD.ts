/**
 * 类名:FeatureRegionFldsCRUD(界面:FeatureRegionFldsCRUD,00050127)
 * 表名:FeatureRegionFlds(00050452)
 * 版本:2025.05.12.1(服务器:WIN-SRV103-116)
 * 日期:2025/05/15 01:36:22
 * 生成者:
 工程名称:AGC(0005)
...
/** FeatureRegionFldsCRUD 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScriptCS_TS4TypeScript:GeneCode)
 **/
export abstract class FeatureRegionFldsCRUD implements clsOperateList {
  ...
  public static objPageCRUD: FeatureRegionFldsCRUD;
  public static sortFunStatic: (ascOrDesc: string) => (x: any, y: any) => number;
  constructor() {
    this.listPara = new ListPara(divVarSet.refDivLayout, divVarSet.refDivList);
    FeatureRegionFldsCRUD.objPageCRUD = this;
  ...
  public async PageLoadCache() {
    ...
    try {
      ...
      if (viewVarSet.sortFeatureRegionFldsBy == '')
        viewVarSet.sortFeatureRegionFldsBy = `${clsFeatureRegionFldsEN.con_RegionId} Asc`;
  ...
  public CombineData4Func(
    ...
    const intRowNum = arrFeatureRegionFldsExObjLst.length;
    const intColNum = arrDataColumn.length;
    const arrData: Array<Record<string, any>> = [];
    for (let i = 0; i < intRowNum; i++) {
      const objEN: clsFeatureRegionFldsENEx = arrFeatureRegionFldsExObjLst[i];
      const objRow: Record<string, any> = {};
      for (let j = 0; j < intColNum; j++) {
        const fldName = arrDataColumn[j].fldName;
        const colHeader = arrDataColumn[j].colHeader;
   ...
   **/
  public async ExportExcel_FeatureRegionFlds4Func(): Promise<ExportExcelData> {
    const strThisFuncName = this.ExportExcel_FeatureRegionFlds4Func.name;
    ...
    try {
      ...
      const arrFeatureRegionFldsObjLst = await FeatureRegionFlds_GetSubObjLstCache(
        objFeatureRegionFldsCond,
        RegionId_Static.value,
      );
      arrFeatureRegionFldsExObjLst = arrFeatureRegionFldsObjLst.map(FeatureRegionFldsEx_CopyToEx);
    } catch (e) {
    ...
    try {
      const arrDataColumn: Array<clsDataColumn> = [
        {
          fldName: clsFeatureRegionFldsENEx.con_RegionTypeName,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '区域类型名',
        ...
        {
          fldName: clsFeatureRegionFldsENEx.con_FeatureName,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '功能名',
        ...
        {
          fldName: clsFeatureRegionFldsENEx.con_CtlCnName,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '控件类型中文名',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_Text,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '文本',
        ...
        {
          fldName: clsFeatureRegionFldsENEx.con_CtlTypeAbbr,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '控件类型缩写',
        ...
        {
          fldName: clsFeatureRegionFldsENEx.con_ViewImplName,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '界面实现名',
        ...
        {
          fldName: clsFeatureRegionFldsENEx.con_CtlTypeName,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '控件类型名',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_Height,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '高度',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_Width,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '宽',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_CssClass,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '样式表',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_ImageUrl,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '图片资源',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_UpdUser,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '修改者',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_UpdDate,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '修改日期',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_Memo,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '说明',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_ViewFeatureId,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '界面功能Id',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_FeatureDescription,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '功能说明',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_DefaultValue,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '缺省值',
        ...
        {
          fldName: clsFeatureRegionFldsEN.con_GroupName,
          sortBy: '',
          sortFun: SortFun,
          getDataSource: '',
          colHeader: '组名',
      ...
      arrFeatureRegionFldsExObjLst = arrFeatureRegionFldsExObjLst.sort(this.SortFunExportExcel);
      return this.CombineData(arrFeatureRegionFldsExObjLst, arrDataColumn);
  ...
  public async btnExportExcel_Click() {
    await this.ExportExcel_FeatureRegionFlds4Func();
  }
  ...
  public async BindTab_FeatureRegionFlds(
    ...
    const arrDataColumn: Array<clsDataColumn> = [
      ...
      {
        fldName: clsFeatureRegionFldsEN.con_Text,
        sortBy: clsFeatureRegionFldsEN.con_Text,
        sortFun: SortFun,
        getDataSource: '',
        colHeader: '文本',
        text: '',
      ...
      {
        fldName: clsFeatureRegionFldsEN.con_RegionId,
        sortBy: 'tabName',
        sortFun: SortFun,
        getDataSource: '',
        colHeader: '表名',
   ...
   * @param arrFeatureRegionFldsExObjLst:需要绑定的对象列表
   **/
  public async BindTab_FeatureRegionFlds4Func(
    ...
    if (refFeatureRegionFlds_List.value != null) {
      ...
      const divDataLst = GetDivObjInDivObj(divContainer, 'divDataLst');
      if (divDataLst == null) {
        alert('在BindTab_FeatureRegionFlds4Func函数中，divDataLst不存在!');
        return;
      }
      await BindTab(
        divDataLst,
  ...
  public async IndexPage(intPageIndex: number) {
    ...
    await this.BindGv_FeatureRegionFlds4Func(this.listPara.listDiv);
  }
  ...
  public async BindGv_FeatureRegionFlds4Func(divList: HTMLDivElement) {
    const strThisFuncName = this.BindGv_FeatureRegionFlds4Func.name;
    if (viewVarSet.sortFeatureRegionFldsBy == null) {
      const strMsg = Format(
        '在显示列表时,排序字段(sortFeatureRegionFldsBy)为空,请检查!(In BindGv_FeatureRegionFldsCache)',
      );
    ...
    try {
      ...
      if (FeatureRegionFldsCRUD.sortFunStatic != undefined) {
        strSortFun = FeatureRegionFldsCRUD.sortFunStatic(viewVarSet.ascOrDesc4SortFun);
      }
    ...
    try {
      ...
      //console.log("完成BindGv_FeatureRegionFlds4Func!");
    } catch (e) {
      const strMsg = `绑定${this.thisTabName}对象列表不成功, ${e}.(in ${this.constructor.name}.${strThisFuncName})`;
      console.error(strMsg);
      alert(strMsg);
  ...
  public async SortBy(objAnchorElement: any) {
    ...
    FeatureRegionFldsCRUD.sortFunStatic = sortFun;
    await this.BindGv_FeatureRegionFlds4Func(this.listPara.listDiv);
  }
