/**
 * 类名:Function4GeneCode_Edit(界面:Function4GeneCodeCRUD,00050342)
 * 表名:Function4GeneCode(00050311)
 * 版本:2025.06.13.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/15 23:44:28
 * 生成者:
 工程名称:AGC(0005)
...
import {
  ...
  Function4GeneCode_GetUniCondStr,
...
/** Function4GeneCode_Edit 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScript_EditCS_TS4TypeScript:GeneCode)
 **/
export abstract class Function4GeneCode_Edit {
  ...
  public static objPageEdit: Function4GeneCode_Edit;
  public static objPageEdit2: Function4GeneCode_Edit;
  public static objPageEdit3: Function4GeneCode_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList | null) {
    ...
    if (Function4GeneCode_Edit.SetPageEdit(this, 1) == true) return;
    if (Function4GeneCode_Edit.SetPageEdit(this, 2) == true) return;
    if (Function4GeneCode_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (Function4GeneCode_Edit.objPageEdit == null) {
          Function4GeneCode_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = Function4GeneCode_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (Function4GeneCode_Edit.objPageEdit2 == null) {
          Function4GeneCode_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = Function4GeneCode_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            Function4GeneCode_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (Function4GeneCode_Edit.objPageEdit3 == null) {
          Function4GeneCode_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = Function4GeneCode_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            Function4GeneCode_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (Function4GeneCode_Edit.objPageEdit != null) {
      const strClassNameOld = Function4GeneCode_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return Function4GeneCode_Edit.objPageEdit;
    }
    if (Function4GeneCode_Edit.objPageEdit2 != null) {
      const strClassNameOld = Function4GeneCode_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return Function4GeneCode_Edit.objPageEdit2;
    }
    if (Function4GeneCode_Edit.objPageEdit3 != null) {
      const strClassNameOld = Function4GeneCode_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return Function4GeneCode_Edit.objPageEdit3;
    }
    return null;
  }
   ...
   **/
  public async btnUpdateRecordInTab_Click(strFuncId4GC: string) {
    ...
    try {
      ...
      const bolIsSuccess = await this.ShowDialog_Function4GeneCode(this.opType);
      if (bolIsSuccess == false) return;
      this.UpdateRecord(strFuncId4GC);
    } catch (e) {
      const strMsg = Format(
   ...
   **/
  public async btnUpdateRecord_Click(strFuncId4GC: string) {
    ...
    try {
      ...
      const update = await this.UpdateRecord(strFuncId4GC);
      if (update == false) {
        ...
        case '确认添加':
          ...
          if (['02', '03', '06'].indexOf(clsFunction4GeneCodeEN.PrimaryTypeId) > -1) {
            ...
            if (IsNullOrEmpty(returnKeyId) == false) {
              if (Function4GeneCode_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01)
                this.HideDialog_Function4GeneCode();
              if (this.iShowList != null)
                this.iShowList.BindGv(clsFunction4GeneCodeEN._CurrTabName, returnKeyId);
            }
          } else {
            ...
            if (returnBool == true) {
              ...
              if (this.iShowList != null)
                this.iShowList.BindGv(clsFunction4GeneCodeEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
  ...
  public SetKeyReadOnly(bolReadonly: boolean) {
    $('#txtFuncId4GC').attr('ReadOnly', bolReadonly.toString());
  }
  ...
  public async AddNewRecord() {
    ...
    //wucFunction4GeneCodeB1.funcId4GC = Function4GeneCodeGetMaxStrId_S();
    try {
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.funcId4GC = await Function4GeneCode_GetMaxStrIdAsync();
    try {
      const returnString = await Function4GeneCode_GetMaxStrIdAsync();
      if (returnString == '') {
        const strInfo = Format('获取表Function4GeneCode的最大关键字为空,不成功,请检查!');
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objFunction4GeneCodeEN);
   ...
   **/
  public async CheckUniCond4Add(objFunction4GeneCodeEN: clsFunction4GeneCodeEN): Promise<boolean> {
   ...
   * @param strFuncId4GC: 表记录的关键字,显示该表关键字的内容
   **/
  public async ShowData(strFuncId4GC: string) {
   ...
   **/
  public async UpdateRecord(strFuncId4GC: string): Promise<boolean> {
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    const objFunction4GeneCodeEN =
      await refFunction4GeneCode_Edit.value.GetEditDataFunction4GeneCodeObj();
    objFunction4GeneCodeEN.SetFuncId4GC(this.keyId);
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Update(objFunction4GeneCodeEN);
      if (bolIsExistCond == false) {
        return false;
      }
