/**
 * 类名:FunctionTemplate_Edit(界面:FunctionTemplateCRUD,00050347)
 * 表名:FunctionTemplate(00050312)
 * 版本:2026.04.19(服务器:WIN-SRV103-116)
 * 日期:2026/04/28 23:47:02
 * 生成者:
 工程名称:AGC(0005)
...
/** FunctionTemplate_Edit 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScript_EditCS_TS4TypeScript:GeneCode)
 **/
export abstract class FunctionTemplate_Edit {
  ...
  public static objPageEdit: FunctionTemplate_Edit;
  public static objPageEdit2: FunctionTemplate_Edit;
  public static objPageEdit3: FunctionTemplate_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList | null) {
    ...
    if (FunctionTemplate_Edit.SetPageEdit(this, 1) == true) return;
    if (FunctionTemplate_Edit.SetPageEdit(this, 2) == true) return;
    if (FunctionTemplate_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (FunctionTemplate_Edit.objPageEdit == null) {
          FunctionTemplate_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = FunctionTemplate_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (FunctionTemplate_Edit.objPageEdit2 == null) {
          FunctionTemplate_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = FunctionTemplate_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            FunctionTemplate_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (FunctionTemplate_Edit.objPageEdit3 == null) {
          FunctionTemplate_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = FunctionTemplate_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            FunctionTemplate_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (FunctionTemplate_Edit.objPageEdit != null) {
      const strClassNameOld = FunctionTemplate_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return FunctionTemplate_Edit.objPageEdit;
    }
    if (FunctionTemplate_Edit.objPageEdit2 != null) {
      const strClassNameOld = FunctionTemplate_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return FunctionTemplate_Edit.objPageEdit2;
    }
    if (FunctionTemplate_Edit.objPageEdit3 != null) {
      const strClassNameOld = FunctionTemplate_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return FunctionTemplate_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public async btnUpdateRecordInTab_Click(strFunctionTemplateId: string) {
    ...
    try {
      ...
      const bolIsSuccess = await this.ShowDialog_FunctionTemplate(this.opType);
      if (bolIsSuccess == false) return;
      this.UpdateRecord(strFunctionTemplateId);
    } catch (e) {
      const strMsg = Format(
  ...
  public SetKeyReadOnly(bolReadonly: boolean) {
    $('#txtFunctionTemplateId').attr('ReadOnly', bolReadonly.toString());
  }
  ...
  public async AddNewRecord() {
    ...
    //wucFunctionTemplateB1.functionTemplateId = FunctionTemplateGetMaxStrId_S();
    try {
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.functionTemplateId = await FunctionTemplate_GetMaxStrIdAsync();
    try {
      const returnString = await FunctionTemplate_GetMaxStrIdAsync();
      if (returnString == '') {
        const strInfo = Format('获取表FunctionTemplate的最大关键字为空,不成功,请检查!');
   ...
   * @param strFunctionTemplateId: 表记录的关键字,显示该表关键字的内容
   **/
