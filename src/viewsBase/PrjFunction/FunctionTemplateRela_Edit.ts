/**
 * 类名:FunctionTemplateRela_Edit(界面:FunctionTemplateRelaCRUD,00050327)
 * 表名:FunctionTemplateRela(00050313)
 * 版本:2025.05.03.1(服务器:WIN-SRV103-116)
 * 日期:2025/05/08 11:51:05
 * 生成者:
 工程名称:AGC(0005)
...
// import $ from 'jquery';
import {
  FunctionTemplateRela_CheckPropertyNew,
...
/** FunctionTemplateRela_Edit 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScript_EditCS_TS4TypeScript:GeneCode)
 **/
export abstract class FunctionTemplateRela_Edit {
  ...
  public static objPageEdit: FunctionTemplateRela_Edit;
  public static objPageEdit2: FunctionTemplateRela_Edit;
  public static objPageEdit3: FunctionTemplateRela_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList | null) {
    ...
    if (FunctionTemplateRela_Edit.SetPageEdit(this, 1) == true) return;
    if (FunctionTemplateRela_Edit.SetPageEdit(this, 2) == true) return;
    if (FunctionTemplateRela_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (FunctionTemplateRela_Edit.objPageEdit == null) {
          FunctionTemplateRela_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = FunctionTemplateRela_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (FunctionTemplateRela_Edit.objPageEdit2 == null) {
          FunctionTemplateRela_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = FunctionTemplateRela_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            FunctionTemplateRela_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (FunctionTemplateRela_Edit.objPageEdit3 == null) {
          FunctionTemplateRela_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = FunctionTemplateRela_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            FunctionTemplateRela_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (FunctionTemplateRela_Edit.objPageEdit != null) {
      const strClassNameOld = FunctionTemplateRela_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return FunctionTemplateRela_Edit.objPageEdit;
    }
    if (FunctionTemplateRela_Edit.objPageEdit2 != null) {
      const strClassNameOld = FunctionTemplateRela_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return FunctionTemplateRela_Edit.objPageEdit2;
    }
    if (FunctionTemplateRela_Edit.objPageEdit3 != null) {
      const strClassNameOld = FunctionTemplateRela_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return FunctionTemplateRela_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_FunctionTemplateRela() {
    if (FunctionTemplateRela_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
  ...
  public async ShowDialog_FunctionTemplateRela(strOp: string): Promise<boolean> {
    ...
    if (FunctionTemplateRela_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (refFunctionTemplateRela_Edit.value == null) {
        const strMsg = Format(
      ...
      await refFunctionTemplateRela_Edit.value.showDialog(this);
    }
    if (strOp === 'Add' || strOp === 'AddWithMaxId') {
      this.btnSubmitFunctionTemplateRela = '确认添加';
      this.btnCancelFunctionTemplateRela = '取消添加';
    } else if (strOp === 'Update') {
      this.btnSubmitFunctionTemplateRela = '确认修改';
      this.btnCancelFunctionTemplateRela = '取消修改';
    }
    return true;
  }
  ...
  public async btnSubmit_Click() {
    ...
    const strCommandText: string = this.btnSubmitFunctionTemplateRela;
    try {
      ...
      switch (strCommandText) {
          ...
          if (['02', '03', '06'].indexOf(clsFunctionTemplateRelaEN.PrimaryTypeId) > -1) {
            ...
            if (returnKeyId != 0) {
              ...
              if (this.iShowList != null)
                this.iShowList.BindGvCache(clsFunctionTemplateRelaEN._CurrTabName, '');
            }
          } else {
        ...
        case '确认修改':
          ...
          strInfo += '(In FunctionTemplateRela_Edit.btnSubmit_Click)';
          //显示信息框
          //console.log(strInfo);
          alert(strInfo);
          if (returnBool == true) {
            ...
            if (this.iShowList != null)
              this.iShowList.BindGv(clsFunctionTemplateRelaEN._CurrTabName, this.keyId.toString());
          }
          break;
        default:
          strMsg = Format(
  ...
  public async AddNewRecord() {
    ...
    refFunctionTemplateRela_Edit.value.Clear();
    //wucFunctionTemplateRelaB1.mId = FunctionTemplateRelaGetMaxStrId_S();
  }
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.mId = await FunctionTemplateRela_GetMaxStrIdAsync();
  }
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objFunctionTemplateRelaEN);
      ...
      if (returnBool == true) {
        ...
        const strInfo = `添加[函数与模板关系(FunctionTemplateRela)]记录成功!`;
        //显示信息框
  ...
  public async CheckUniCond4Add(
    ...
    const bolIsExistCondition = await FunctionTemplateRela_IsExistRecordAsync(
  ...
  public async AddNewRecordWithReturnKeySave(): Promise<number> {
    ...
    try {
      ...
      const responseKeyId = await FunctionTemplateRela_AddNewRecordWithReturnKeyAsync(
        objFunctionTemplateRelaEN,
      );
      const returnKeyId: string = responseKeyId;
      if (IsNullOrEmpty(returnKeyId) == false) {
        objFunctionTemplateRelaEN.mId = Number(returnKeyId);
        //FunctionTemplateRela_ReFreshCache();
        const strInfo = `添加[函数与模板关系(FunctionTemplateRela)]记录成功!`;
        //显示信息框
        if (this.isShowMsg == true) alert(strInfo);
  ...
  public async ShowData(lngmId: number) {
    ...
    try {
      ...
      objFunctionTemplateRelaEN = objFunctionTemplateRelaENConst;
    } catch (e) {
      const strMsg = Format(
    ...
    //3、用提供的关键字初始化一个类对象；
    refFunctionTemplateRela_Edit.value.ShowDataFromFunctionTemplateRelaObj(
      objFunctionTemplateRelaEN,
    );
  }
  ...
  public async UpdateRecord(lngmId: number): Promise<boolean> {
    ...
    try {
      ...
      await refFunctionTemplateRela_Edit.value.ShowDataFromFunctionTemplateRelaObj(
        objFunctionTemplateRelaEN,
      );
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    const objFunctionTemplateRelaEN =
      await refFunctionTemplateRela_Edit.value.GetEditDataFunctionTemplateRelaObj();
    objFunctionTemplateRelaEN.SetmId(Number(this.keyId));
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Update(objFunctionTemplateRelaEN);
      if (bolIsExistCond == false) {
        return false;
      }
      ...
      if (returnBool == true) {
        //FunctionTemplateRela_ReFreshCache();
        //FunctionTemplateRela_DeleteKeyIdCache(this.keyId);
      }
      return returnBool;
    } catch (e) {
      const strMsg = Format(
  ...
  public async EditRecordExSave(): Promise<boolean> {
    ...
    try {
      ...
      const returnBool = await FunctionTemplateRela_EditRecordExAsync(objFunctionTemplateRelaEN);
      if (returnBool == true) {
        //FunctionTemplateRela_ReFreshCache();
      }
      return returnBool;
   ...
   **/
  public set btnCancelFunctionTemplateRela(value: string) {
    refFunctionTemplateRela_Edit.value.strCancelButtonText = value;
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitFunctionTemplateRela(): string {
    const strValue = refFunctionTemplateRela_Edit.value.strSubmitButtonText;
    return strValue;
  }
  /**
   * 设置确定按钮的标题(Used In AddNewRecord())
   **/
  public set btnSubmitFunctionTemplateRela(value: string) {
    refFunctionTemplateRela_Edit.value.strSubmitButtonText = value;
  }
}
