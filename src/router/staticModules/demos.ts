...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      // },
      {
        ...
        name: 'DropdownTabs',
        // redirect: '/dashboard/welcome',
        component: () => import(/* webpackChunkName: "layout" */ '@/views/test/DropdownTabs.vue'),
        meta: {
          title: 'DropdownTabs',
          icon: 'icon-zhuomian',
          keepAlive: true,
      ...
      {
        path: '/ShowDnPathByTable',
        name: 'ShowDnPathByTable',
        // redirect: '/dashboard/welcome',
        component: () =>
          import(/* webpackChunkName: "layout" */ '@/views/AIModule/ShowDnPathByTable.vue'),
        meta: {
          title: 'ShowDnPathByTable',
          icon: 'icon-zhuomian',
          keepAlive: true,
        },
        children: [],
