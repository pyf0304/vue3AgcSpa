...
import { clsPrjFileTypeENEx } from "@/ts/L0Entity/GeneCode/clsPrjFileTypeENEx";
import { PrjFileType_SortFunByKey } from "@/ts/L3ForWApi/GeneCode/clsPrjFileTypeWApi";
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, prjFileTypeEx_ConstructorName, strThisFuncName);
...
*/
export  function PrjFileTypeEx_FuncMapByFldName(strFldName: string, objPrjFileTypeEx: clsPrjFileTypeENEx)
{
