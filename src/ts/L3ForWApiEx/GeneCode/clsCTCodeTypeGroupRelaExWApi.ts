...
import {
  CTCodeTypeGroupRela_GetObjLstByPagerAsync,
  CTCodeTypeGroupRela_SortFunByKey,
...
import {
  CTCodeTypeGroup_func,
  CTCodeTypeGroup_funcKey,
 ...
 **/
export function CTCodeTypeGroupRelaEx_GetWebApiUrl(
 ...
 **/
export function CTCodeTypeGroupRelaEx_CopyToEx(
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      cTCodeTypeGroupRelaEx_ConstructorName,
      strThisFuncName,
    );
 ...
 * @returns 对象列表
 */
export async function CTCodeTypeGroupRelaEx_GetObjExLstByPagerAsync(
  objPagerPara: stuPagerPara,
): Promise<Array<clsCTCodeTypeGroupRelaENEx>> {
  const strThisFuncName = 'GetObjExLstByPagerAsync';
  const arrCTCodeTypeGroupRelaObjLst = await CTCodeTypeGroupRela_GetObjLstByPagerAsync(
    objPagerPara,
  );
  const arrCTCodeTypeGroupRelaExObjLst = arrCTCodeTypeGroupRelaObjLst.map(
    CTCodeTypeGroupRelaEx_CopyToEx,
  );
  ...
  try {
    if (objPagerPara.orderBy != null && objPagerPara.orderBy.length > 0) {
      ...
      arrCTCodeTypeGroupRelaSel = arrCTCodeTypeGroupRelaSel.sort(
        CTCodeTypeGroupRelaEx_SortFunByKey(strSortFld, strSortType),
      );
    } else {
    ...
    const intPageSize =
      objPagerPara.pageSize > 0 ? objPagerPara.pageSize : arrCTCodeTypeGroupRelaSel.length;
 ...
 **/
export async function CTCodeTypeGroupRelaEx_FuncMapCodeTypeName(
 ...
 * @param objCTCodeTypeGroupRelaS:源对象
 **/
export async function CTCodeTypeGroupRelaEx_FuncMapGroupName(
  objCTCodeTypeGroupRela: clsCTCodeTypeGroupRelaENEx,
) {
  ...
  try {
    ...
    const strMsg = Format(
      '(errid:Watl001229)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      cTCodeTypeGroupRelaEx_ConstructorName,
      strThisFuncName,
    );
 ...
 */
export function CTCodeTypeGroupRelaEx_FuncMapByFldName(
  strFldName: string,
 ...
 * @param objCTCodeTypeGroupRelaS:源对象
 **/
export async function CTCodeTypeGroupRelaEx_FuncMapKeyCodeTypeName(
  objCTCodeTypeGroupRela: clsCTCodeTypeGroupRelaENEx,
  ...
  try {
    ...
    const arrCodeTypeId = await vCodeType_Sim_funcKey(
      clsvCodeType_SimEN.con_CodeTypeName,
    ...
    const strMsg = Format(
      '(errid:Watl001233)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      cTCodeTypeGroupRelaEx_ConstructorName,
      strThisFuncName,
    );
 ...
 * @param objCTCodeTypeGroupRelaS:源对象
 **/
export async function CTCodeTypeGroupRelaEx_FuncMapKeyGroupName(
  objCTCodeTypeGroupRela: clsCTCodeTypeGroupRelaENEx,
): Promise<Array<string>> {
  ...
  try {
    ...
    const arrCtGroupId = await CTCodeTypeGroup_funcKey(
      clsCTCodeTypeGroupEN.con_GroupName,
      CTCodeTypeGroupGroupName,
      enumComparisonOp.Like_03,
    );
    return arrCtGroupId;
  } catch (e) {
    const strMsg = Format(
      '(errid:Watl001234)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      cTCodeTypeGroupRelaEx_ConstructorName,
      strThisFuncName,
    );
