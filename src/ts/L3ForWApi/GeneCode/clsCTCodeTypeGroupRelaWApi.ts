...
import { clsCTCodeTypeGroupRelaEN,CTCodeTypeGroupRelaKey } from "@/ts/L0Entity/GeneCode/clsCTCodeTypeGroupRelaEN";
 ...
 * @returns 对象
 **/
export async function CTCodeTypeGroupRela_GetObjByKeyAsync(key: CTCodeTypeGroupRelaKey): Promise<clsCTCodeTypeGroupRelaEN|null>  
{
const strThisFuncName = "GetObjByKeyAsync";
if (key.ctGroupId === undefined || key.ctGroupId === null || key.ctGroupId === "")
{
const strMsg = Format("关键字段[CtGroupId]不能为空!(in {0}.{1})", cTCodeTypeGroupRela_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
if (key.codeTypeId === undefined || key.codeTypeId === null || key.codeTypeId === "")
{
const strMsg = Format("关键字段[CodeTypeId]不能为空!(in {0}.{1})", cTCodeTypeGroupRela_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
...
{
const strInfo = Format("网络错误!访问地址:{0}不成功!(in {1}.{2})", strUrl, cTCodeTypeGroupRela_ConstructorName, strThisFuncName);
console.error(strInfo);
throw(strInfo);
}
else if (error.statusText == "Not Found")
{
const strInfo = Format("网络错误!访问地址:{0}可能不存在!(in {1}.{2})", strUrl, cTCodeTypeGroupRela_ConstructorName, strThisFuncName);
console.error(strInfo);
throw(strInfo);
}
else
 ...
 * @returns 返回两个对象比较的结果
*/
export  function CTCodeTypeGroupRela_SortFunDefa(a:clsCTCodeTypeGroupRelaEN , b:clsCTCodeTypeGroupRelaEN): number 
{
 ...
 **/
export  async function CTCodeTypeGroupRela_GetFldValueAsync(strFldName: string, strWhereCond: string): Promise<Array<string>>  
{
 ...
 * @returns 第一条记录对象
 **/
export  async function CTCodeTypeGroupRela_GetFirstObjAsync(strWhereCond: string): Promise<clsCTCodeTypeGroupRelaEN|null>  
{
 ...
 * @returns 获取的相应对象列表
 **/
export  async function CTCodeTypeGroupRela_GetObjLstAsync(strWhereCond: string): Promise<Array<clsCTCodeTypeGroupRelaEN>>  
{
...
{
const strNullInfo = Format("获取数据为null, 请注意!(in {0}.{1})", cTCodeTypeGroupRela_ConstructorName, strThisFuncName);
 ...
 * @returns 获取的相应对象列表
 **/
export  async function CTCodeTypeGroupRela_GetTopObjLstAsync(objTopPara: stuTopPara): Promise<Array<clsCTCodeTypeGroupRelaEN>>  
{
 ...
 * @returns 获取的相应记录对象列表
 **/
export  async function CTCodeTypeGroupRela_GetObjLstByRangeAsync(objRangePara: stuRangePara): Promise<Array<clsCTCodeTypeGroupRelaEN>>  
{
 ...
 * @returns 获取的相应记录对象列表
 **/
export  async function CTCodeTypeGroupRela_GetObjLstByPagerAsync(objPagerPara: stuPagerPara): Promise<Array<clsCTCodeTypeGroupRelaEN>>  
{
 ...
 * @returns 获取删除的结果
 **/
export async function CTCodeTypeGroupRela_DelRecordAsync(key: CTCodeTypeGroupRelaKey): Promise<number>
{
 ...
 * @returns 实际删除记录的个数
 **/
export  async function CTCodeTypeGroupRela_DelRecKeyLstsAsync(arrKeyLsts: Array<string>): Promise<number> 
{
 ...
 **/
export  function CTCodeTypeGroupRela_CopyToEx(objCTCodeTypeGroupRelaENS:clsCTCodeTypeGroupRelaEN ): clsCTCodeTypeGroupRelaENEx
{
...
{
const strMsg = Format("(errid:Watl001294)Copy表对象数据出错,{0}.(in {1}.{2})", e, cTCodeTypeGroupRela_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
 return objCTCodeTypeGroupRelaENT;
}
...
*/
export  function CTCodeTypeGroupRela_FuncMapByFldName(strFldName: string, objCTCodeTypeGroupRelaEx: clsCTCodeTypeGroupRelaENEx)
{
 ...
 **/
export  async function CTCodeTypeGroupRela_FuncMapCodeTypeName(objCTCodeTypeGroupRela:clsCTCodeTypeGroupRelaENEx )
{
...
{
const strMsg = Format("(errid:Watl001309)函数映射表对象数据出错,{0}.(in {1}.{2})", e, cTCodeTypeGroupRela_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objCTCodeTypeGroupRelaS:源对象
 **/
export  async function CTCodeTypeGroupRela_FuncMapGroupName(objCTCodeTypeGroupRela:clsCTCodeTypeGroupRelaENEx )
{
...
{
const strMsg = Format("(errid:Watl001310)函数映射表对象数据出错,{0}.(in {1}.{2})", e, cTCodeTypeGroupRela_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @returns 实际删除记录的个数
 **/
export  async function CTCodeTypeGroupRela_DelCTCodeTypeGroupRelasByCondAsync(strWhereCond: string): Promise<number> 
{
 ...
 * @returns 获取相应的记录的对象
 **/
export  async function CTCodeTypeGroupRela_AddNewRecordAsync(objCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN): Promise<boolean> 
{
 ...
 * @returns 获取相应的记录的对象
 **/
export  async function CTCodeTypeGroupRela_AddNewRecordWithMaxIdAsync(objCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN): Promise<string> 
{
 ...
 **/
export  async function CTCodeTypeGroupRela_AddNewObjSave(objCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN ): Promise<AddRecordResult>{
 ...
 **/
export  async function CTCodeTypeGroupRela_UpdateObjSave(objCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN): Promise<boolean>{
 ...
 * @returns 返回新添加记录的关键字
 **/
export  async function CTCodeTypeGroupRela_AddNewRecordWithReturnKeyAsync(objCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN): Promise<string> 
{
 ...
 * @returns 获取修改是否成功？
 **/
export  async function CTCodeTypeGroupRela_UpdateRecordAsync(objCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN): Promise<boolean>  
{
const strThisFuncName = "UpdateRecordAsync";
const strAction = "UpdateRecord";
 if (objCTCodeTypeGroupRelaEN.sfUpdFldSetStr === undefined || objCTCodeTypeGroupRelaEN.sfUpdFldSetStr === null || objCTCodeTypeGroupRelaEN.sfUpdFldSetStr === "")
{
const strMsg = Format("对象(关键字: {0})的【修改字段集】为空,不能修改!", objCTCodeTypeGroupRelaEN.ctGroupId);
 throw strMsg;
 }
const strUrl = GetWebApiUrl(cTCodeTypeGroupRela_Controller, strAction);
 ...
 * @returns 获取修改是否成功？
 **/
export  async function CTCodeTypeGroupRela_EditRecordExAsync(objCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN): Promise<boolean>  
{
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export  async function CTCodeTypeGroupRela_UpdateWithConditionAsync(objCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN, strWhereCond: string ): Promise<boolean> 
{
 ...
 * @returns 是否存在记录？
 **/
export  async function CTCodeTypeGroupRela_IsExistRecordAsync(strWhereCond: string): Promise<boolean>  
{
 ...
 **/
export async function CTCodeTypeGroupRela_IsExistAsync(key: CTCodeTypeGroupRelaKey): Promise<boolean> 
{
 ...
 * @returns 获取某一条件的记录数
 **/
export  async function CTCodeTypeGroupRela_GetRecCountByCondAsync(strWhereCond: string): Promise<number>  
{
...
*/
export  function CTCodeTypeGroupRela_CheckPropertyNew(pobjCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN)
{
//检查字段非空, 即数据表要求非常非空的字段,不能为空!
if (null === pobjCTCodeTypeGroupRelaEN.isMainGroup 
 || pobjCTCodeTypeGroupRelaEN.isMainGroup != null && pobjCTCodeTypeGroupRelaEN.isMainGroup.toString()  ===  "")
{
...
{
 throw new Error(`(errid:Watl000413)字段[Ct组Id(ctGroupId)]的长度不能超过4(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!值:${pobjCTCodeTypeGroupRelaEN.ctGroupId}(clsCTCodeTypeGroupRelaBL:CheckPropertyNew)`);
}
...
{
 throw new Error(`(errid:Watl000413)字段[修改日期(updDate)]的长度不能超过20(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!值:${pobjCTCodeTypeGroupRelaEN.updDate}(clsCTCodeTypeGroupRelaBL:CheckPropertyNew)`);
}
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.updUser) == false && GetStrLen(pobjCTCodeTypeGroupRelaEN.updUser) > 20)
{
 throw new Error(`(errid:Watl000413)字段[修改者(updUser)]的长度不能超过20(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!值:${pobjCTCodeTypeGroupRelaEN.updUser}(clsCTCodeTypeGroupRelaBL:CheckPropertyNew)`);
}
//检查字段的数据类型是否正确
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.ctGroupId) == false && undefined !== pobjCTCodeTypeGroupRelaEN.ctGroupId && tzDataType.isString(pobjCTCodeTypeGroupRelaEN.ctGroupId) === false)
{
 throw new Error(`(errid:Watl000414)字段[Ct组Id(ctGroupId)]的值:[${pobjCTCodeTypeGroupRelaEN.ctGroupId}], 非法,应该为字符型(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!(clsCTCodeTypeGroupRelaBL:CheckPropertyNew0)`);
}
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.codeTypeId) == false && undefined !== pobjCTCodeTypeGroupRelaEN.codeTypeId && tzDataType.isString(pobjCTCodeTypeGroupRelaEN.codeTypeId) === false)
{
 throw new Error(`(errid:Watl000414)字段[代码类型Id(codeTypeId)]的值:[${pobjCTCodeTypeGroupRelaEN.codeTypeId}], 非法,应该为字符型(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!(clsCTCodeTypeGroupRelaBL:CheckPropertyNew0)`);
}
if (null != pobjCTCodeTypeGroupRelaEN.isMainGroup && undefined !== pobjCTCodeTypeGroupRelaEN.isMainGroup && tzDataType.isBoolean(pobjCTCodeTypeGroupRelaEN.isMainGroup) === false)
{
 throw new Error(`(errid:Watl000414)字段[IsMainGroup(isMainGroup)]的值:[${pobjCTCodeTypeGroupRelaEN.isMainGroup}], 非法,应该为布尔型(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!(clsCTCodeTypeGroupRelaBL:CheckPropertyNew0)`);
}
...
{
 throw new Error(`(errid:Watl000414)字段[修改日期(updDate)]的值:[${pobjCTCodeTypeGroupRelaEN.updDate}], 非法,应该为字符型(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!(clsCTCodeTypeGroupRelaBL:CheckPropertyNew0)`);
}
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.updUser) == false && undefined !== pobjCTCodeTypeGroupRelaEN.updUser && tzDataType.isString(pobjCTCodeTypeGroupRelaEN.updUser) === false)
{
 throw new Error(`(errid:Watl000414)字段[修改者(updUser)]的值:[${pobjCTCodeTypeGroupRelaEN.updUser}], 非法,应该为字符型(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!(clsCTCodeTypeGroupRelaBL:CheckPropertyNew0)`);
}
 ...
 * (AutoGCLib.WA_Access4TypeScript:Gen_4BL_Ts_CheckPropertyNew)
*/
export  function CTCodeTypeGroupRela_CheckProperty4Update(pobjCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN)
{
//检查字段长度, 若字符型字段长度超出规定的长度,即非法!
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.ctGroupId) == false && GetStrLen(pobjCTCodeTypeGroupRelaEN.ctGroupId) > 4)
{
 throw new Error(`(errid:Watl000416)字段[Ct组Id(ctGroupId)]的长度不能超过4(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!值:${pobjCTCodeTypeGroupRelaEN.ctGroupId}(clsCTCodeTypeGroupRelaBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.codeTypeId) == false && GetStrLen(pobjCTCodeTypeGroupRelaEN.codeTypeId) > 4)
{
...
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.updUser) == false && GetStrLen(pobjCTCodeTypeGroupRelaEN.updUser) > 20)
{
 throw new Error(`(errid:Watl000416)字段[修改者(updUser)]的长度不能超过20(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!值:${pobjCTCodeTypeGroupRelaEN.updUser}(clsCTCodeTypeGroupRelaBL:CheckProperty4Update)`);
}
//检查字段的数据类型是否正确
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.ctGroupId) == false && undefined !== pobjCTCodeTypeGroupRelaEN.ctGroupId && tzDataType.isString(pobjCTCodeTypeGroupRelaEN.ctGroupId) === false)
{
 throw new Error(`(errid:Watl000417)字段[Ct组Id(ctGroupId)]的值:[${pobjCTCodeTypeGroupRelaEN.ctGroupId}], 非法,应该为字符型(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!(clsCTCodeTypeGroupRelaBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.codeTypeId) == false && undefined !== pobjCTCodeTypeGroupRelaEN.codeTypeId && tzDataType.isString(pobjCTCodeTypeGroupRelaEN.codeTypeId) === false)
{
 throw new Error(`(errid:Watl000417)字段[代码类型Id(codeTypeId)]的值:[${pobjCTCodeTypeGroupRelaEN.codeTypeId}], 非法,应该为字符型(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!(clsCTCodeTypeGroupRelaBL:CheckProperty4Update)`);
}
if (null != pobjCTCodeTypeGroupRelaEN.isMainGroup && undefined !== pobjCTCodeTypeGroupRelaEN.isMainGroup && tzDataType.isBoolean(pobjCTCodeTypeGroupRelaEN.isMainGroup) === false)
{
 throw new Error(`(errid:Watl000417)字段[IsMainGroup(isMainGroup)]的值:[${pobjCTCodeTypeGroupRelaEN.isMainGroup}], 非法,应该为布尔型(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!(clsCTCodeTypeGroupRelaBL:CheckProperty4Update)`);
}
if (null != pobjCTCodeTypeGroupRelaEN.orderNum && undefined !== pobjCTCodeTypeGroupRelaEN.orderNum && tzDataType.isNumber(pobjCTCodeTypeGroupRelaEN.orderNum) === false)
{
...
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.updUser) == false && undefined !== pobjCTCodeTypeGroupRelaEN.updUser && tzDataType.isString(pobjCTCodeTypeGroupRelaEN.updUser) === false)
{
 throw new Error(`(errid:Watl000417)字段[修改者(updUser)]的值:[${pobjCTCodeTypeGroupRelaEN.updUser}], 非法,应该为字符型(In CTCodeTypeGroupRela(CTCodeTypeGroupRela))!(clsCTCodeTypeGroupRelaBL:CheckProperty4Update)`);
}
//检查主键是否为Null或者空!
if (IsNullOrEmpty(pobjCTCodeTypeGroupRelaEN.ctGroupId) === true )
{
 throw new Error(`(errid:Watl000064)字段[Ct组Id]不能为空(In CTCodeTypeGroupRela)!(clsCTCodeTypeGroupRelaBL:CheckProperty4Update)`);
}
//检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
 ...
 * @returns 返回一个生成的对象
*/
export  function CTCodeTypeGroupRela_GetJSONStrByObj (pobjCTCodeTypeGroupRelaEN: clsCTCodeTypeGroupRelaEN): string
{
 ...
 * @returns 返回一个生成的对象列表
*/
export  function CTCodeTypeGroupRela_GetObjLstByJSONStr (strJSON: string): Array<clsCTCodeTypeGroupRelaEN>
{
 ...
 * @returns 返回一个生成的对象列表
*/
export  function CTCodeTypeGroupRela_GetObjLstByJSONObjLst (arrCTCodeTypeGroupRelaObjLstS: Array<clsCTCodeTypeGroupRelaEN>): Array<clsCTCodeTypeGroupRelaEN>
{
...
*/
export  function CTCodeTypeGroupRela_GetCombineCondition(objCTCodeTypeGroupRelaCond: clsCTCodeTypeGroupRelaEN ):string
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
if (Object.prototype.hasOwnProperty.call(objCTCodeTypeGroupRelaCond.dicFldComparisonOp, clsCTCodeTypeGroupRelaEN.con_CtGroupId) == true)
{
const strComparisonOpCtGroupId:string = objCTCodeTypeGroupRelaCond.dicFldComparisonOp[clsCTCodeTypeGroupRelaEN.con_CtGroupId];
strWhereCond += Format(" And {0} {2} '{1}'", clsCTCodeTypeGroupRelaEN.con_CtGroupId, objCTCodeTypeGroupRelaCond.ctGroupId, strComparisonOpCtGroupId);
}
if (Object.prototype.hasOwnProperty.call(objCTCodeTypeGroupRelaCond.dicFldComparisonOp, clsCTCodeTypeGroupRelaEN.con_CodeTypeId) == true)
{
const strComparisonOpCodeTypeId:string = objCTCodeTypeGroupRelaCond.dicFldComparisonOp[clsCTCodeTypeGroupRelaEN.con_CodeTypeId];
strWhereCond += Format(" And {0} {2} '{1}'", clsCTCodeTypeGroupRelaEN.con_CodeTypeId, objCTCodeTypeGroupRelaCond.codeTypeId, strComparisonOpCodeTypeId);
}
if (Object.prototype.hasOwnProperty.call(objCTCodeTypeGroupRelaCond.dicFldComparisonOp, clsCTCodeTypeGroupRelaEN.con_IsMainGroup) == true)
{
...
if (Object.prototype.hasOwnProperty.call(objCTCodeTypeGroupRelaCond.dicFldComparisonOp, clsCTCodeTypeGroupRelaEN.con_OrderNum) == true)
{
...
{
const strComparisonOpUpdDate:string = objCTCodeTypeGroupRelaCond.dicFldComparisonOp[clsCTCodeTypeGroupRelaEN.con_UpdDate];
strWhereCond += Format(" And {0} {2} '{1}'", clsCTCodeTypeGroupRelaEN.con_UpdDate, objCTCodeTypeGroupRelaCond.updDate, strComparisonOpUpdDate);
}
if (Object.prototype.hasOwnProperty.call(objCTCodeTypeGroupRelaCond.dicFldComparisonOp, clsCTCodeTypeGroupRelaEN.con_UpdUser) == true)
{
const strComparisonOpUpdUser:string = objCTCodeTypeGroupRelaCond.dicFldComparisonOp[clsCTCodeTypeGroupRelaEN.con_UpdUser];
strWhereCond += Format(" And {0} {2} '{1}'", clsCTCodeTypeGroupRelaEN.con_UpdUser, objCTCodeTypeGroupRelaCond.updUser, strComparisonOpUpdUser);
}
 return strWhereCond;
}
...
*/
export  function CTCodeTypeGroupRela_GetObjFromJsonObj(objCTCodeTypeGroupRelaENS: clsCTCodeTypeGroupRelaEN): clsCTCodeTypeGroupRelaEN 
{
