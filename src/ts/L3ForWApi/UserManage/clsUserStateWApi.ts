 ...
 * @returns 对象
 **/
export async function UserState_GetObjByUserStateIdAsync(
  strUserStateId: string,
): Promise<clsUserStateEN | null> {
  const strThisFuncName = 'GetObjByUserStateIdAsync';

  if (IsNullOrEmpty(strUserStateId) == true) {
    const strMsg = Format(
      '参数:[strUserStateId]不能为空!(In clsUserStateWApi.GetObjByUserStateIdAsync)',
    );
  ...
  if (strUserStateId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strUserStateId]的长度:[{0}]不正确!(clsUserStateWApi.GetObjByUserStateIdAsync)',
...
//该表没有使用Cache,不需要生成[GetObjByUserStateIdCache]函数;(in AutoGCLib.WA_Access4TypeScript:Gen_4WA_Ts_GetObjByKeyIdCache )
//该表没有使用Cache,不需要生成[GetObjByUserStateIdlocalStorage]函数;(in AutoGCLib.WA_Access4TypeScript:Gen_4WA_Ts_GetObjByKeyId_localStorage)
//该表没有使用Cache,不需要生成[UpdateObjInLstCache]函数;(in AutoGCLib.WA_Access4TypeScript:Gen_4WA_Ts_UpdateObjInLstCache
//该表没有使用Cache,不需要生成[GetNameByUserStateIdCache]函数;(in AutoGCLib.WA_Access4TypeScript:Gen_4WA_Ts_GetNameByKeyIdCache)
...
//该表没有使用Cache,不需要生成[UserState__funcKey]函数;(in AutoGCLib.WA_Access4TypeScript:Gen_4WA_Ts_funcKey)
 ...
 * @returns 第一条记录对象
 **/
export async function UserState_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsUserStateEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function UserState_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsUserStateEN>> {
 ...
 * @returns 对象列表
 **/
export async function UserState_GetObjLstByUserStateIdLstAsync(
...
//该表没有使用Cache,不需要生成[GetObjLstByUserStateIdLstCache]函数;(in AutoGCLib.WA_Access4TypeScript:Gen_4WA_Ts_GetObjLstByKeyLstCache)
 ...
 * @returns 获取的相应对象列表
 **/
export async function UserState_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function UserState_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function UserState_GetObjLstByPagerAsync(
 ...
 * @returns 获取相应的记录的对象
 **/
export async function UserState_AddNewRecordAsync(
  objUserStateEN: clsUserStateEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function UserState_AddNewRecordWithMaxIdAsync(
  objUserStateEN: clsUserStateEN,
): Promise<string> {
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function UserState_AddNewRecordWithReturnKeyAsync(
  objUserStateEN: clsUserStateEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function UserState_UpdateRecordAsync(
  objUserStateEN: clsUserStateEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objUserStateEN.sfUpdFldSetStr === undefined ||
    objUserStateEN.sfUpdFldSetStr === null ||
    objUserStateEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function UserState_UpdateWithConditionAsync(
  objUserStateEN: clsUserStateEN,
  strWhereCond: string,
): Promise<boolean> {
...
*/
export async function UserState_BindDdl_UserStateIdInDiv(
  ...
  const arrObjLstSel = await UserState_GetObjLstAsync(strCondition);
...
export function UserState_CheckPropertyNew(pobjUserStateEN: clsUserStateEN) {
  ...
  if (IsNullOrEmpty(pobjUserStateEN.userStateName) === true) {
    throw new Error(
      '(errid:Watl000411)字段[用户状态名]不能为空(In UserState)!(clsUserStateBL:CheckPropertyNew0)',
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjUserStateEN.userStateId) == false &&
    GetStrLen(pobjUserStateEN.userStateId) > 2
  ) {
    throw new Error(
      '(errid:Watl000413)字段[用户状态号(userStateId)]的长度不能超过2(In UserState(UserState))!值:$(pobjUserStateEN.userStateId)(clsUserStateBL:CheckPropertyNew)',
    );
  }
  if (
    IsNullOrEmpty(pobjUserStateEN.userStateName) == false &&
    GetStrLen(pobjUserStateEN.userStateName) > 20
  ) {
    throw new Error(
      '(errid:Watl000413)字段[用户状态名(userStateName)]的长度不能超过20(In UserState(UserState))!值:$(pobjUserStateEN.userStateName)(clsUserStateBL:CheckPropertyNew)',
    );
  }
  if (IsNullOrEmpty(pobjUserStateEN.memo) == false && GetStrLen(pobjUserStateEN.memo) > 1000) {
    throw new Error(
      '(errid:Watl000413)字段[说明(memo)]的长度不能超过1000(In UserState(UserState))!值:$(pobjUserStateEN.memo)(clsUserStateBL:CheckPropertyNew)',
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjUserStateEN.userStateId) == false &&
    undefined !== pobjUserStateEN.userStateId &&
    tzDataType.isString(pobjUserStateEN.userStateId) === false
  ) {
    throw new Error(
      '(errid:Watl000414)字段[用户状态号(userStateId)]的值:[$(pobjUserStateEN.userStateId)], 非法,应该为字符型(In UserState(UserState))!(clsUserStateBL:CheckPropertyNew0)',
    );
  }
  if (
    IsNullOrEmpty(pobjUserStateEN.userStateName) == false &&
    undefined !== pobjUserStateEN.userStateName &&
    tzDataType.isString(pobjUserStateEN.userStateName) === false
  ) {
    throw new Error(
      '(errid:Watl000414)字段[用户状态名(userStateName)]的值:[$(pobjUserStateEN.userStateName)], 非法,应该为字符型(In UserState(UserState))!(clsUserStateBL:CheckPropertyNew0)',
    );
  }
  if (
    IsNullOrEmpty(pobjUserStateEN.memo) == false &&
    undefined !== pobjUserStateEN.memo &&
    tzDataType.isString(pobjUserStateEN.memo) === false
  ) {
    throw new Error(
      '(errid:Watl000414)字段[说明(memo)]的值:[$(pobjUserStateEN.memo)], 非法,应该为字符型(In UserState(UserState))!(clsUserStateBL:CheckPropertyNew0)',
    );
  }
...
export function UserState_CheckProperty4Update(pobjUserStateEN: clsUserStateEN) {
  ...
  if (
    ...
    throw new Error(
      '(errid:Watl000416)字段[用户状态号(userStateId)]的长度不能超过2(In UserState(UserState))!值:$(pobjUserStateEN.userStateId)(clsUserStateBL:CheckProperty4Update)',
    );
  }
  if (
    IsNullOrEmpty(pobjUserStateEN.userStateName) == false &&
    ...
    throw new Error(
      '(errid:Watl000416)字段[用户状态名(userStateName)]的长度不能超过20(In UserState(UserState))!值:$(pobjUserStateEN.userStateName)(clsUserStateBL:CheckProperty4Update)',
    );
  }
  if (IsNullOrEmpty(pobjUserStateEN.memo) == false && GetStrLen(pobjUserStateEN.memo) > 1000) {
    throw new Error(
      '(errid:Watl000416)字段[说明(memo)]的长度不能超过1000(In UserState(UserState))!值:$(pobjUserStateEN.memo)(clsUserStateBL:CheckProperty4Update)',
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      '(errid:Watl000417)字段[用户状态号(userStateId)]的值:[$(pobjUserStateEN.userStateId)], 非法,应该为字符型(In UserState(UserState))!(clsUserStateBL:CheckProperty4Update)',
    );
  }
  if (
    IsNullOrEmpty(pobjUserStateEN.userStateName) == false &&
    ...
    throw new Error(
      '(errid:Watl000417)字段[用户状态名(userStateName)]的值:[$(pobjUserStateEN.userStateName)], 非法,应该为字符型(In UserState(UserState))!(clsUserStateBL:CheckProperty4Update)',
    );
  }
  if (
    IsNullOrEmpty(pobjUserStateEN.memo) == false &&
    ...
    throw new Error(
      '(errid:Watl000417)字段[说明(memo)]的值:[$(pobjUserStateEN.memo)], 非法,应该为字符型(In UserState(UserState))!(clsUserStateBL:CheckProperty4Update)',
    );
  }
  //检查主键是否为Null或者空!
  if (IsNullOrEmpty(pobjUserStateEN.userStateId) === true) {
    throw new Error(
      '(errid:Watl000064)字段[用户状态号]不能为空(In UserState)!(clsUserStateBL:CheckProperty4Update)',
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function UserState_GetObjLstByJSONObjLst(
  arrUserStateObjLstS: Array<clsUserStateEN>,
): Array<clsUserStateEN> {
...
export function UserState_GetCombineCondition(objUserStateCond: clsUserStateEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objUserStateCond.dicFldComparisonOp,
      clsUserStateEN.con_UserStateId,
    ) == true
  ) {
    const strComparisonOpUserStateId: string =
      objUserStateCond.dicFldComparisonOp[clsUserStateEN.con_UserStateId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUserStateEN.con_UserStateId,
      objUserStateCond.userStateId,
  ...
  if (
    ...
    const strComparisonOpUserStateName: string =
      objUserStateCond.dicFldComparisonOp[clsUserStateEN.con_UserStateName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUserStateEN.con_UserStateName,
      objUserStateCond.userStateName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objUserStateCond.dicFldComparisonOp,
      clsUserStateEN.con_Memo,
    ) == true
  ) {
    const strComparisonOpMemo: string =
      objUserStateCond.dicFldComparisonOp[clsUserStateEN.con_Memo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUserStateEN.con_Memo,
      objUserStateCond.memo,
      strComparisonOpMemo,
    );
  }
  return strWhereCond;
