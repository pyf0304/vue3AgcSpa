 ...
 * @returns 对象
 */
export async function ViewTabType_GetObjByKeyIdCache(key: ViewTabTypeKey, bolTryAsyncOnce = true) {
...
export async function ViewTabType_func(
  ...
  const objViewTabType = await ViewTabType_GetObjByKeyAsync({ viewTabTypeId: strViewTabTypeId });
