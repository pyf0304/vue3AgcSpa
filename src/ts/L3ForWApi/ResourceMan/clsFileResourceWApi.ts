 ...
 * @returns 对象
 **/
export async function FileResource_GetObjByKeyAsync(
  key: FileResourceKey,
  ...
  if (key.fileResourceId === undefined || key.fileResourceId === null || key.fileResourceId === 0) {
    const strMsg = Format(
      '关键字段[FileResourceId]不能为空!(in {0}.{1})',
 ...
 **/
export async function FileResource_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
 ...
 */
export function FileResource_FuncMapByFldName(
  strFldName: string,
...
export async function FileResource_FuncMapPrjFileTypeName(objFileResource: clsFileResourceENEx) {
  ...
  try {
    ...
    const strMsg = Format(
      '(errid:Watl001541)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      fileResource_ConstructorName,
      strThisFuncName,
    );
 ...
 **/
export async function FileResource_AddNewObjSave(
  objFileResourceEN: clsFileResourceEN,
 ...
 **/
export async function FileResource_CheckUniCond4Add(
  objFileResourceEN: clsFileResourceEN,
): Promise<boolean> {
 ...
 **/
export async function FileResource_CheckUniCond4Update(
  objFileResourceEN: clsFileResourceEN,
): Promise<boolean> {
 ...
 **/
export async function FileResource_UpdateObjSave(
  objFileResourceEN: clsFileResourceEN,
): Promise<boolean> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function FileResource_EditRecordExAsync(
  objFileResourceEN: clsFileResourceEN,
): Promise<boolean> {
...
export function FileResource_CheckPropertyNew(pobjFileResourceEN: clsFileResourceEN) {
  ...
  if (
    IsNullOrEmpty(pobjFileResourceEN.codeTypeId) === true ||
    pobjFileResourceEN.codeTypeId.toString() === '0'
  ) {
    throw new Error(
      `(errid:Watl000411)字段[代码类型Id]不能为空(In 文件资源)!(clsFileResourceBL:CheckPropertyNew0)`,
    );
  }
  if (
  ...
  if (
    IsNullOrEmpty(pobjFileResourceEN.codeTypeId) == false &&
    GetStrLen(pobjFileResourceEN.codeTypeId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[代码类型Id(codeTypeId)]的长度不能超过4(In 文件资源(FileResource))!值:${pobjFileResourceEN.codeTypeId}(clsFileResourceBL:CheckPropertyNew)`,
    );
  }
  ...
  if (
    IsNullOrEmpty(pobjFileResourceEN.prjFileTypeId) == false &&
    GetStrLen(pobjFileResourceEN.prjFileTypeId) > 2
  ) {
    throw new Error(
      `(errid:Watl000413)字段[项目文件类型Id(prjFileTypeId)]的长度不能超过2(In 文件资源(FileResource))!值:${pobjFileResourceEN.prjFileTypeId}(clsFileResourceBL:CheckPropertyNew)`,
    );
  }
  if (
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[文件资源Id(fileResourceId)]的值:[${pobjFileResourceEN.fileResourceId}], 非法,应该为数值型(In 文件资源(FileResource))!(clsFileResourceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFileResourceEN.fileDirName) == false &&
  ...
  if (
    IsNullOrEmpty(pobjFileResourceEN.codeTypeId) == false &&
    undefined !== pobjFileResourceEN.codeTypeId &&
    tzDataType.isString(pobjFileResourceEN.codeTypeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[代码类型Id(codeTypeId)]的值:[${pobjFileResourceEN.codeTypeId}], 非法,应该为字符型(In 文件资源(FileResource))!(clsFileResourceBL:CheckPropertyNew0)`,
    );
  }
  if (
  ...
  if (
    IsNullOrEmpty(pobjFileResourceEN.prjFileTypeId) == false &&
    undefined !== pobjFileResourceEN.prjFileTypeId &&
    tzDataType.isString(pobjFileResourceEN.prjFileTypeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[项目文件类型Id(prjFileTypeId)]的值:[${pobjFileResourceEN.prjFileTypeId}], 非法,应该为字符型(In 文件资源(FileResource))!(clsFileResourceBL:CheckPropertyNew0)`,
    );
  }
  if (
...
export function FileResource_CheckProperty4Update(pobjFileResourceEN: clsFileResourceEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[代码类型Id(codeTypeId)]的长度不能超过4(In 文件资源(FileResource))!值:${pobjFileResourceEN.codeTypeId}(clsFileResourceBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjFileResourceEN.tabId) == false && GetStrLen(pobjFileResourceEN.tabId) > 8) {
    throw new Error(
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[项目文件类型Id(prjFileTypeId)]的长度不能超过2(In 文件资源(FileResource))!值:${pobjFileResourceEN.prjFileTypeId}(clsFileResourceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFileResourceEN.fileType) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[文件资源Id(fileResourceId)]的值:[${pobjFileResourceEN.fileResourceId}], 非法,应该为数值型(In 文件资源(FileResource))!(clsFileResourceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFileResourceEN.fileDirName) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[代码类型Id(codeTypeId)]的值:[${pobjFileResourceEN.codeTypeId}], 非法,应该为字符型(In 文件资源(FileResource))!(clsFileResourceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFileResourceEN.tabId) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[项目文件类型Id(prjFileTypeId)]的值:[${pobjFileResourceEN.prjFileTypeId}], 非法,应该为字符型(In 文件资源(FileResource))!(clsFileResourceBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjFileResourceEN.isGeneCode &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000064)字段[文件资源Id]不能为空(In 文件资源)!(clsFileResourceBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
...
export function FileResource_GetCombineCondition(objFileResourceCond: clsFileResourceEN): string {
  ...
  if (
    ...
    const strComparisonOpCodeTypeId: string =
      objFileResourceCond.dicFldComparisonOp[clsFileResourceEN.con_CodeTypeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFileResourceEN.con_CodeTypeId,
      objFileResourceCond.codeTypeId,
  ...
  if (
    ...
    const strComparisonOpPrjFileTypeId: string =
      objFileResourceCond.dicFldComparisonOp[clsFileResourceEN.con_PrjFileTypeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFileResourceEN.con_PrjFileTypeId,
      objFileResourceCond.prjFileTypeId,
