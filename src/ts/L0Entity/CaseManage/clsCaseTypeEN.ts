...
export class clsCaseTypeEN extends clsGeneralTab {
  ...
  public static _KeyFldName = 'CaseTypeId'; //当前表中的关键字名称,与该类相关的表中关键字名
  public static mintAttributeCount = 3;
  public static AttributeName = ['caseTypeId', 'caseTypeName', 'memo'];
  //以下是属性变量
   ...
   */
  private mstrCaseTypeId = ''; //CaseTypeId
  private mstrCaseTypeName = ''; //案例类型名
  private mstrMemo = ''; //说明
   ...
   */
  public caseTypeId = ''; //CaseTypeId
  public caseTypeName = ''; //案例类型名
  public memo = ''; //说明
   ...
   */
  public static get con_CaseTypeId(): string {
    return 'caseTypeId';
  } //CaseTypeId
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static get con_CaseTypeName(): string {
    return 'caseTypeName';
  } //案例类型名
  ...
  public static hasProperty(propName: string): boolean {
    //return propName in new clsCaseTypeEN();
