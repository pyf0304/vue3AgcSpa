...
public static readonly _AttributeName = ["mId", "viewId", "regionId", "inOutTypeId", "viewTabTypeId", "tabId", "tabFunction", "prjId", "relaFldNames", "updDate", "updUser", "memo"];
//以下是属性变量
