...
export class clsDataNodeCmPrjIdRelaEN extends clsGeneralTab {
  ...
  public static _CurrTabName = 'DataNodeCmPrjIdRela'; //当前表名,与该类相关的表名
  public static _KeyFldName = 'CmPrjId,DataNodeId'; //当前表中的关键字名称,与该类相关的表中关键字名
  public static mintAttributeCount = 5;
  public static AttributeName = ['cmPrjId', 'dataNodeId', 'updDate', 'updUser', 'memo'];
  //以下是属性变量
  ...
  public GetFldValue(strFldName: string): any {
    ...
    switch (strFldName) {
      ...
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[DataNodeCmPrjIdRela]中不存在!`;
  ...
  public SetFldValue(strFldName: string, strValue: string) {
    ...
    switch (strFldName) {
      ...
      case 'sfFldComparisonOp':
        ...
        break;
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[DataNodeCmPrjIdRela]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
        console.error(strMsg);
        break;
    }
  }
