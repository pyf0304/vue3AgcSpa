...
export class clsApplicationTypeENEx extends clsApplicationTypeEN {
  //以下是属性变量
  ...
  public static hasProperty(propName: string): boolean {
    //return propName in new clsApplicationTypeENEx();
    const instance = new clsApplicationTypeENEx();
