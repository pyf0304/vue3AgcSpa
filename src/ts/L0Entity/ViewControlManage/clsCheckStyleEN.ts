...
export class clsCheckStyleEN extends clsGeneralTab {
  public static CacheAddiCondition = ''; //缓存附加条件，作为向后台调取数据的附加条件
  public static CacheModeId = '03'; //localStorage
  public static IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
  public static WhereFormat = ''; //条件格式串
  public static _CurrTabName = 'CheckStyle'; //当前表名,与该类相关的表名
  public static _KeyFldName = 'CheckStyleId'; //当前表中的关键字名称,与该类相关的表中关键字名
   ...
   */
  private mstrCheckStyleId = ''; //CheckStyleId
  private mstrCheckStyleName = ''; //CheckStyleName
   ...
   */
  public SetCheckStyleId(value: string) {
    if (value != undefined) {
      this.checkStyleId = value;
      this.hmProperty['checkStyleId'] = true;
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
   */
  public SetCheckStyleName(value: string) {
    if (value != undefined) {
      this.checkStyleName = value;
      this.hmProperty['checkStyleName'] = true;
      this.sfUpdFldSetStr = this.updFldString;
    }
  }
  ...
  public GetFldValue(strFldName: string): any {
    ...
    switch (strFldName) {
      ...
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[CheckStyle]中不存在！`;
  ...
  public SetFldValue(strFldName: string, strValue: string) {
    ...
    switch (strFldName) {
      case clsCheckStyleEN.con_CheckStyleId:
        this.checkStyleId = strValue;
        this.hmProperty['checkStyleId'] = true;
        break;
      case clsCheckStyleEN.con_CheckStyleName:
        this.checkStyleName = strValue;
        this.hmProperty['checkStyleName'] = true;
        break;
      case clsCheckStyleEN.con_Style:
        this.style = strValue;
      ...
      case 'sfFldComparisonOp':
        ...
        break;
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[CheckStyle]中不存在！(in ${this.constructor.name}.${strThisFuncName})`;
        console.error(strMsg);
        break;
    }
  }
   ...
   */
  public checkStyleId = ''; //CheckStyleId
  public checkStyleName = ''; //CheckStyleName
  public style = ''; //类型
  public runat = ''; //运行在
  public fontSize = ''; //字号
  public fontName = ''; //字体
   ...
   */
  public static get con_CheckStyleId(): string {
    return 'checkStyleId';
  } //CheckStyleId
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get con_CheckStyleName(): string {
