...
export class clsCharEncodingEN extends clsGeneralTab {
  public static CacheAddiCondition = ''; //缓存附加条件,作为向后台调取数据的附加条件
  public static CacheModeId = '03'; //localStorage
  public static IsUseDelSign = false; //使用删除标志,记录不能删除,仅设置删除标志
  public static WhereFormat = ''; //条件格式串
  public static _CurrTabName = 'CharEncoding'; //当前表名,与该类相关的表名
  public static _KeyFldName = 'CharEncodingId'; //当前表中的关键字名称,与该类相关的表中关键字名
  public static mintAttributeCount = 4;
  public static AttributeName = ['charEncodingId', 'charEncodingName', 'isDefault', 'memo'];
  //以下是属性变量
  ...
  private mstrCharEncodingName = ''; //字符编码名称
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
   */
  public SetCharEncodingName(value: string) {
    if (value != undefined) {
  ...
  public GetFldValue(strFldName: string): any {
    ...
    switch (strFldName) {
      ...
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[CharEncoding]中不存在!`;
  ...
  public SetFldValue(strFldName: string, strValue: string) {
    ...
    switch (strFldName) {
      case clsCharEncodingEN.con_CharEncodingId:
        ...
        break;
      case clsCharEncodingEN.con_CharEncodingName:
        this.charEncodingName = strValue;
        this.hmProperty['charEncodingName'] = true;
        break;
      case clsCharEncodingEN.con_IsDefault:
      ...
      case 'sfFldComparisonOp':
        ...
        break;
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[CharEncoding]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
        console.error(strMsg);
        break;
    }
  }
