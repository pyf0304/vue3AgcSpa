/**
 * 类名:clsPrjTabRelationENEx
 * 表名:PrjTabRelation(00050606)
 * 版本:2025.06.13.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/14 11:49:31
 * 生成者:pyf
 工程名称:AGC(0005)
...
export class clsPrjTabRelationENEx extends clsPrjTabRelationEN {
  //以下是属性变量
  ...
  public static hasProperty(propName: string): boolean {
    //return propName in new clsPrjTabRelationENEx();
    const instance = new clsPrjTabRelationENEx();
