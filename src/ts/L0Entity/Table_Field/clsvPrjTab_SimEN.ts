...
public static readonly _CurrTabName: string = "vPrjTab_Sim"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "TabId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 12;
public static readonly _AttributeName = ["tabId", "tabName", "sqlDsTypeId", "funcModuleAgcId", "tabTypeId", "cacheModeId", "tabStateId", "prjId", "dataBaseName", "updDate", "fldNum", "isShare"];
//以下是属性变量
