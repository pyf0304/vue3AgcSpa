...
export class clsFunctionTemplateEN extends clsGeneralTab {
  ...
  public static readonly _CurrTabName: string = 'FunctionTemplate'; //当前表名,与该类相关的表名
  public static readonly _KeyFldName: string = 'FunctionTemplateId'; //当前表中的关键字名称,与该类相关的表中关键字名
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static readonly con_FunctionTemplateENName = 'functionTemplateENName'; //函数模板英文名
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static readonly con_CreateUserId = 'createUserId'; //建立用户Id
