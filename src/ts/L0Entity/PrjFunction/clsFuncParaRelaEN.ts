...
export class clsFuncParaRelaEN extends clsGeneralTab {
  ...
  public static _CurrTabName = 'FuncParaRela'; //当前表名,与该类相关的表名
  ...
  public GetFldValue(strFldName: string): any {
    ...
    switch (strFldName) {
      ...
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[FuncParaRela]中不存在!`;
  ...
  public SetFldValue(strFldName: string, strValue: string) {
    ...
    switch (strFldName) {
      ...
      case 'sfFldComparisonOp':
        ...
        break;
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[FuncParaRela]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
        console.error(strMsg);
        break;
    }
  }
  ...
  public static hasProperty(propName: string): boolean {
    //return propName in new clsFuncParaRelaEN();
    const instance = new clsFuncParaRelaEN();
