...
export class clsvPrjFeatureSimENEx extends clsvPrjFeatureSimEN {
  //以下是属性变量
  ...
  public GetFldValue(strFldName: string): any {
    ...
    switch (strFldName) {
      case 'CtrlId':
        return '';
      case clsvPrjFeatureSimENEx.con_ButtonSet:
  ...
  public static hasProperty(propName: string): boolean {
    //return propName in new clsvPrjFeatureSimENEx();
    const instance = new clsvPrjFeatureSimENEx();
