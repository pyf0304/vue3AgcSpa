...
export class clsFuncGCTypeEN extends clsGeneralTab {
  public static CacheAddiCondition = ''; //缓存附加条件,作为向后台调取数据的附加条件
  public static CacheModeId = '03'; //localStorage
  public static IsUseDelSign = false; //使用删除标志,记录不能删除,仅设置删除标志
  public static WhereFormat = ''; //条件格式串
  public static _CurrTabName = 'FuncGCType'; //当前表名,与该类相关的表名
  public static _KeyFldName = 'FuncGCTypeId'; //当前表中的关键字名称,与该类相关的表中关键字名
  ...
  private mstrFuncGCTypeName = ''; //函数生成代码类型名
  private mstrFuncGCTypeENName = ''; //函数生成代码类型英文名
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
   */
  public SetFuncGCTypeName(value: string) {
    if (value != undefined) {
      this.funcGCTypeName = value;
      this.hmProperty['funcGCTypeName'] = true;
      this.sfUpdFldSetStr = this.updFldString;
    }
  }
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
   */
  public SetFuncGCTypeENName(value: string) {
    if (value != undefined) {
      this.funcGCTypeENName = value;
      this.hmProperty['funcGCTypeENName'] = true;
      this.sfUpdFldSetStr = this.updFldString;
    }
  }
  ...
  public GetFldValue(strFldName: string): any {
    ...
    switch (strFldName) {
      ...
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[FuncGCType]中不存在!`;
  ...
  public SetFldValue(strFldName: string, strValue: string) {
    ...
    switch (strFldName) {
      ...
      case 'sfFldComparisonOp':
        ...
        break;
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[FuncGCType]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
        console.error(strMsg);
        break;
    }
  }
 ...
 **/
export class enumFuncGCType {
  /**
   * 函数
   **/
  static readonly Function_01 = '01';
  /**
   * 函数组
   **/
  static readonly FunctionGroup_02 = '02';
  /**
   * 定义变量
   **/
  static readonly DefVar_03 = '03';
  /**
   * 初始化变量
   **/
  static readonly InitVar_04 = '04';
  /**
   * 内部类
   **/
  static readonly InternalClass_05 = '05';
  /**
   * 定义事件
   **/
  static readonly DefEvent_06 = '06';
  /**
   * 绑定控件变量
   **/
  static readonly BindCtrlVar_07 = '07';
}
