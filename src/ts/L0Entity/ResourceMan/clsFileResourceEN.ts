...
public static readonly _AttributeName = ["fileResourceId", "fileDirName", "fileName", "extension", "codeTypeId", "tabId", "isBelongsCurrCMPrj", "prjFileTypeId", "isGeneCode", "isCanDel", "fileLength", "fileType", "creationTime", "lastWriteTime", "checkDateTime", "inUse", "isExistFile", "prjId", "cmPrjId", "ipAddress", "idFtpResource", "updDate", "updUser", "memo"];
//以下是属性变量
