 ...
 **/
export type ViewFeatureFldsKey = {
  mId: number;
};
...
private mbolIsNeedAuxControlLabel = false;    //是否需要附件标签
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetIsNeedAuxControlLabel (value: boolean)
{
if (value  != undefined)
{
 this.isNeedAuxControlLabel = value;
    this.hmProperty["isNeedAuxControlLabel"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
return this.isNeedAuxControlLabel;
...
break;
case clsViewFeatureFldsEN.con_IsNeedAuxControlLabel:
this.isNeedAuxControlLabel = Boolean(strValue);
    this.hmProperty["isNeedAuxControlLabel"] = true;
break;
case clsViewFeatureFldsEN.con_CtlTypeId:
...
public isNeedAuxControlLabel = false;    //是否需要附件标签
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_ViewFeatureId = "viewFeatureId";    //界面功能Id

 /**
 * 常量:"FieldTypeId"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_FieldTypeId = "fieldTypeId";    //字段类型Id

 /**
 * 常量:"ReleFldId"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_ReleFldId = "releFldId";    //相关字段Id
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_LabelCaption = "labelCaption";    //标签标题

 /**
 * 常量:"IsNeedAuxControlLabel"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_IsNeedAuxControlLabel = "isNeedAuxControlLabel";    //是否需要附件标签

 /**
 * 常量:"CtlTypeId"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_CtlTypeId = "ctlTypeId";    //控件类型号
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_CtrlId = "ctrlId";    //控件Id

 /**
 * 常量:"DefaultValue"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_DefaultValue = "defaultValue";    //缺省值
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_CssClass = "cssClass";    //样式表

 /**
 * 常量:"DdlItemsOptionId"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_DdlItemsOptionId = "ddlItemsOptionId";    //下拉框列表选项ID
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_FldIdCond2 = "fldIdCond2";    //字段Id_条件2

 /**
 * 常量:"FldIdCond1"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_FldIdCond1 = "fldIdCond1";    //字段Id_条件1

 /**
 * 常量:"VarIdCond2"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_VarIdCond2 = "varIdCond2";    //数据源字段_条件1

 /**
 * 常量:"VarIdCond1"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_VarIdCond1 = "varIdCond1";    //变量Id_条件1

 /**
 * 常量:"TabFeatureId4Ddl"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_TabFeatureId4Ddl = "tabFeatureId4Ddl";    //下拉框表功能Id

 /**
 * 常量:"ViewImplId"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_ViewImplId = "viewImplId";    //界面实现Id

 /**
 * 常量:"Text"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_Text = "text";    //文本

 /**
 * 常量:"DsCondStr"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_DsCondStr = "dsCondStr";    //数据源条件串

 /**
 * 常量:"DsSqlStr"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_DsSqlStr = "dsSqlStr";    //数据源SQL串

 /**
 * 常量:"ItemsString"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_ItemsString = "itemsString";    //列表项串
