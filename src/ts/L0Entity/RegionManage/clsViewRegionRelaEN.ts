...
export class clsViewRegionRelaEN extends clsGeneralTab {
  ...
  public static WhereFormat =
    "ViewId in (Select ViewId from ViewInfoCmPrjIdRela where CmPrjId='{0}')"; //条件格式串
  public static _CurrTabName = 'ViewRegionRela'; //当前表名,与该类相关的表名
  ...
  public GetFldValue(strFldName: string): any {
    ...
    switch (strFldName) {
      ...
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[ViewRegionRela]中不存在!`;
  ...
  public SetFldValue(strFldName: string, strValue: string) {
    ...
    switch (strFldName) {
      ...
      case 'sfFldComparisonOp':
        ...
        break;
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[ViewRegionRela]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
        console.error(strMsg);
        break;
    }
  }
  ...
  public static hasProperty(propName: string): boolean {
    //return propName in new clsViewRegionRelaEN();
    const instance = new clsViewRegionRelaEN();
