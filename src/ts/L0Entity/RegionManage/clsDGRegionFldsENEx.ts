...
export class clsDGRegionFldsENEx extends clsDGRegionFldsEN {
  //以下是属性变量
  ...
  public static hasProperty(propName: string): boolean {
    //return propName in new clsDGRegionFldsENEx();
    const instance = new clsDGRegionFldsENEx();
