 ...
 **/
/**
 * css_TemplateStyle(cssTemplateStyle)
 * (AutoGCLib.EntityLayer4TypeScript:GeneCode)
 **/
import { clsGeneralTab } from '@/ts/PubFun/clsGeneralTab';

export class clscssTemplateStyleEN extends clsGeneralTab {
  public static CacheAddiCondition = ''; //缓存附加条件，作为向后台调取数据的附加条件
  public static CacheModeId = '05'; //未知
  public static IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
  public static WhereFormat = ''; //条件格式串
  public static _CurrTabName = 'cssTemplateStyle'; //当前表名,与该类相关的表名
  ...
  private mstrcss_ModuleAreaId = ''; //区域主键
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
   */
  public Setcss_ModuleAreaId(value: string) {
    if (value != undefined) {
  ...
  public GetFldValue(strFldName: string): any {
    let strMsg = '';
    switch (strFldName) {
      case clscssTemplateStyleEN.conmId:
        return this.mId;
      case clscssTemplateStyleEN.conStyleId:
        return this.styleId;
      case clscssTemplateStyleEN.conTemplateId:
        return this.templateId;
      case clscssTemplateStyleEN.concssModuleAreaId:
        return this.cssModuleAreaId;
      case clscssTemplateStyleEN.conTemplateStyleName:
        return this.templateStyleName;
      case clscssTemplateStyleEN.conUpdDate:
        return this.updDate;
      case clscssTemplateStyleEN.conUpdUser:
        return this.updUser;
      case clscssTemplateStyleEN.conMemo:
        return this.memo;
      case clscssTemplateStyleEN.conTemplateStyleNameEn:
        return this.templateStyleNameEn;
      case clscssTemplateStyleEN.conIsDelete:
      ...
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[cssTemplateStyle]中不存在！`;
  ...
  public SetFldValue(strFldName: string, strValue: string) {
    ...
    switch (strFldName) {
      ...
      case 'sfFldComparisonOp':
        ...
        break;
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[cssTemplateStyle]中不存在！(in ${this.constructor.name}.${strThisFuncName})`;
        console.error(strMsg);
        break;
    }
  }
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get concssModuleAreaId(): string {
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get conTemplateStyleName(): string {
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get conTemplateStyleNameEn(): string {
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get conIsDelete(): string {
    return 'isDelete';
  } //IsDelete
