...
export class clscssFldDispUnitStyleEN extends clsGeneralTab {
  public static CacheAddiCondition = ''; //缓存附加条件，作为向后台调取数据的附加条件
  public static CacheModeId = '03'; //localStorage
  public static IsUseDelSign = false; //使用删除标志，记录不能删除，仅设置删除标志
  public static WhereFormat = ''; //条件格式串
  public static _CurrTabName = 'cssFldDispUnitStyle'; //当前表名,与该类相关的表名
  ...
  private mstrStyleId_Content = ''; //内容样式Id
  private mstrStyleId_Title = ''; //标题样式Id
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
   */
  public SetStyleId_Content(value: string) {
    if (value != undefined) {
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
   */
  public SetStyleId_Title(value: string) {
    if (value != undefined) {
  ...
  public GetFldValue(strFldName: string): any {
    let strMsg = '';
    switch (strFldName) {
      case clscssFldDispUnitStyleEN.conFldDispUnitStyleId:
        return this.fldDispUnitStyleId;
      case clscssFldDispUnitStyleEN.conFldDispUnitStyleName:
        return this.fldDispUnitStyleName;
      case clscssFldDispUnitStyleEN.conFldDispUnitStyleDesc:
        return this.fldDispUnitStyleDesc;
      case clscssFldDispUnitStyleEN.conStyleIdContent:
        return this.styleIdContent;
      case clscssFldDispUnitStyleEN.conStyleIdTitle:
        return this.styleIdTitle;
      case clscssFldDispUnitStyleEN.conFldDispUnitStyleContent:
        return this.fldDispUnitStyleContent;
      case clscssFldDispUnitStyleEN.conFldDispUnitFormat:
        return this.fldDispUnitFormat;
      case clscssFldDispUnitStyleEN.conCtlTypeId:
        return this.ctlTypeId;
      case clscssFldDispUnitStyleEN.con_OrderNum:
        return this.orderNum;
      case clscssFldDispUnitStyleEN.conDeletedDate:
        return this.deletedDate;
      case clscssFldDispUnitStyleEN.conIsDeleted:
        return this.isDeleted;
      case clscssFldDispUnitStyleEN.conUpdDate:
        return this.updDate;
      case clscssFldDispUnitStyleEN.conUpdUser:
        return this.updUser;
      case clscssFldDispUnitStyleEN.conMemo:
        return this.memo;
      case 'sfUpdFldSetStr':
      ...
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[cssFldDispUnitStyle]中不存在！`;
  ...
  public SetFldValue(strFldName: string, strValue: string) {
    ...
    switch (strFldName) {
      ...
      case 'sfFldComparisonOp':
        ...
        break;
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[cssFldDispUnitStyle]中不存在！(in ${this.constructor.name}.${strThisFuncName})`;
        console.error(strMsg);
        break;
    }
  }
   ...
   */
  public static get conFldDispUnitStyleId(): string {
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get conFldDispUnitStyleName(): string {
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get conFldDispUnitStyleDesc(): string {
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get conStyleIdContent(): string {
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get conStyleIdTitle(): string {
    return 'styleIdTitle';
  } //标题样式Id
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get conFldDispUnitStyleContent(): string {
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get conFldDispUnitFormat(): string {
