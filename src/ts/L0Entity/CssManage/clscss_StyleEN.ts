...
export class clscss_StyleEN extends clsGeneralTab {
  ...
  public static _CurrTabName = 'css_Style'; //当前表名,与该类相关的表名
  ...
  public GetFldValue(strFldName: string): any {
    ...
    switch (strFldName) {
      ...
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[css_Style]中不存在!`;
  ...
  public SetFldValue(strFldName: string, strValue: string) {
    ...
    switch (strFldName) {
      ...
      case 'sfFldComparisonOp':
        ...
        break;
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[css_Style]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
        console.error(strMsg);
        break;
    }
  }
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static get con_StyleName(): string {
    return 'styleName';
  } //样式名称
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static get con_StyleDesc(): string {
    return 'styleDesc';
  } //样式描述
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static get con_StyleContent(): string {
    return 'styleContent';
  } //样式内容
  ...
  public static hasProperty(propName: string): boolean {
    //return propName in new clscss_StyleEN();
    const instance = new clscss_StyleEN();
