...
export class clsCMProjectAppRelaEN extends clsGeneralTab {
  ...
  public SetFldValue(strFldName: string, strValue: string) {
    ...
    switch (strFldName) {
      ...
      case 'sfFldComparisonOp':
        ...
        break;
      default:
        strMsg = `字段名:[${strFldName}]在表对象:[CMProjectAppRela]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
        console.error(strMsg);
        break;
    }
  }
  ...
  public static hasProperty(propName: string): boolean {
    //return propName in new clsCMProjectAppRelaEN();
    const instance = new clsCMProjectAppRelaEN();
